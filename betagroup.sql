...
BEGIN
    ...
    IF SQL%ROWCOUNT = 0 THEN
        RAISE_APPLICATION_ERROR(-20003, 'No se encontr� el usuario a actualizar.');
    END IF;
EXCEPTION
    WHEN OTHERS THEN
...
BEGIN
    ...
    IF SQL%ROWCOUNT = 0 THEN
        RAISE_APPLICATION_ERROR(-20005, 'No se encontr� el usuario a actualizar.');
    END IF;
EXCEPTION
    WHEN OTHERS THEN
...
BEGIN
    ...
    IF SQL%ROWCOUNT = 0 THEN
        RAISE_APPLICATION_ERROR(-20007, 'No se encontr� el usuario a eliminar.');
    END IF;
EXCEPTION
    WHEN OTHERS THEN
...
BEGIN
    ...
    IF SQL%ROWCOUNT = 0 THEN
        RAISE_APPLICATION_ERROR(-20011, 'No se encontr� el cliente a actualizar.');
    END IF;
EXCEPTION
    WHEN OTHERS THEN
...
BEGIN
    ...
    IF SQL%ROWCOUNT = 0 THEN
        RAISE_APPLICATION_ERROR(-20013, 'No se encontr� el cliente a eliminar.');
    END IF;
EXCEPTION
    WHEN OTHERS THEN
...
EXCEPTION
    WHEN DUP_VAL_ON_INDEX THEN
        RAISE_APPLICATION_ERROR(-20016, 'La cl�nica ya existe.');
    WHEN OTHERS THEN
        RAISE_APPLICATION_ERROR(-20017, 'Error al insertar cl�nica: ' || SQLERRM);
END;
/
...
BEGIN
    ...
    IF SQL%ROWCOUNT = 0 THEN
        RAISE_APPLICATION_ERROR(-20018, 'No se encontr� la cl�nica a actualizar.');
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE_APPLICATION_ERROR(-20019, 'Error al actualizar cl�nica: ' || SQLERRM);
END;
/
...
BEGIN
    ...
    IF SQL%ROWCOUNT = 0 THEN
        RAISE_APPLICATION_ERROR(-20020, 'No se encontr� la cl�nica a eliminar.');
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE_APPLICATION_ERROR(-20021, 'Error al eliminar cl�nica: ' || SQLERRM);
END;
/
...
EXCEPTION
    WHEN OTHERS THEN
        RAISE_APPLICATION_ERROR(-20022, 'Error al listar cl�nicas: ' || SQLERRM);
END;
/
...
EXCEPTION
    WHEN OTHERS THEN
        RAISE_APPLICATION_ERROR(-20005, 'Error al listar categor�as: ' || SQLERRM);
END;
/
...
EXCEPTION
    WHEN OTHERS THEN
        RAISE_APPLICATION_ERROR(-20006, 'Error al insertar categor�a: ' || SQLERRM);
END;
/
...
EXCEPTION
    WHEN OTHERS THEN
        RAISE_APPLICATION_ERROR(-20007, 'Error al eliminar categor�a: ' || SQLERRM);
END;
/
...
BEGIN
    ...
    IF SQL%ROWCOUNT = 0 THEN
        RAISE_APPLICATION_ERROR(-20026, 'No se encontr� el proveedor a actualizar');
    END IF;
EXCEPTION
    WHEN OTHERS THEN
...
BEGIN
    -- Eliminar tel�fonos vinculados a este proveedor
    ...
    IF SQL%ROWCOUNT = 0 THEN
        RAISE_APPLICATION_ERROR(-20028, 'No se encontr� el proveedor a eliminar');
    END IF;
EXCEPTION
    WHEN OTHERS THEN
...
BEGIN
    ...
    IF SQL%ROWCOUNT = 0 THEN
        RAISE_APPLICATION_ERROR(-20030, 'No se encontr� el proveedor a habilitar');
    END IF;
EXCEPTION
    WHEN OTHERS THEN
...
EXCEPTION
    WHEN OTHERS THEN
        RAISE_APPLICATION_ERROR(-20033, 'Error al obtener IDs de tel�fonos: ' || SQLERRM);
END;
/

-- 31. Procedimiento para obtener tel�fonos completos de un proveedor
...
EXCEPTION
    WHEN OTHERS THEN
        RAISE_APPLICATION_ERROR(-20034, 'Error al obtener tel�fonos: ' || SQLERRM);
END;
/
...
BEGIN
    ...
    IF SQL%ROWCOUNT = 0 THEN
        RAISE_APPLICATION_ERROR(-20035, 'No se encontr� el tel�fono a actualizar');
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE_APPLICATION_ERROR(-20036, 'Error al actualizar tel�fono: ' || SQLERRM);
END;
/
...
BEGIN
    ...
    IF SQL%ROWCOUNT = 0 THEN
        RAISE_APPLICATION_ERROR(-20037, 'No se encontr� el tel�fono a eliminar');
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE_APPLICATION_ERROR(-20038, 'Error al eliminar tel�fono: ' || SQLERRM);
END;
/
...
EXCEPTION
    WHEN OTHERS THEN
        RAISE_APPLICATION_ERROR(-20039, 'Error al insertar tel�fono: ' || SQLERRM);
END;
/
...
BEGIN
    ...
    IF SQL%ROWCOUNT = 0 THEN
        RAISE_APPLICATION_ERROR(-20040, 'No se encontr� la venta a eliminar');
    END IF;
EXCEPTION
    WHEN OTHERS THEN
...
BEGIN
    ...
    IF SQL%ROWCOUNT = 0 THEN
        RAISE_APPLICATION_ERROR(-20042, 'No se encontr� el detalle de venta a eliminar');
    END IF;
EXCEPTION
    WHEN OTHERS THEN
...
-- 48. Procedimiento para obtener tel�fonos de un cliente
...
-- 49. Procedimiento para obtener solo los IDs de tel�fono de un cliente
...
EXCEPTION
    WHEN NO_DATA_FOUND THEN
        RAISE_APPLICATION_ERROR(-20002, 'No se encontraron clientes para el tipo de cl�nica ' || p_id_tipo_clinica);
    WHEN OTHERS THEN
        RAISE_APPLICATION_ERROR(-20003, 'Error al obtener clientes por cl�nica: ' || SQLERRM);
END;
/
...
BEGIN
  ...
  ELSIF UPDATING THEN
    ...
    v_descripcion := 'Se actualizó el usuario ID=' || :OLD.ID_USUARIO || ' ? ' ||
                     ...
                     'DESPUÉS [NOMBRE=' || :NEW.NOMBRE_USUARIO || ', CORREO=' || :NEW.CORREO || ', TELEFONO=' || :NEW.TELEFONO || ', ROL=' || :NEW.ROL || ']';
...
BEGIN
  IF INSERTING THEN
    v_operacion := 'INSERT';
    v_descripcion := 'Se insertó el proveedor: ' ||
                     'ID=' || :NEW.ID_PROVEEDOR || ', ' ||
  ...
  ELSIF UPDATING THEN
    v_operacion := 'UPDATE';
    v_descripcion := 'Se actualizó el proveedor ID=' || :OLD.ID_PROVEEDOR || ' ? ' ||
                     'ANTES [NOMBRE=' || :OLD.NOMBRE_PROVEEDOR || ', CORREO=' || :OLD.CORREO || ', DIRECCION=' || :OLD.DIRECCION_PROVEEDOR || '] ? ' ||
                     'DESPUÉS [NOMBRE=' || :NEW.NOMBRE_PROVEEDOR || ', CORREO=' || :NEW.CORREO || ', DIRECCION=' || :NEW.DIRECCION_PROVEEDOR || ']';

  ELSIF DELETING THEN
    v_operacion := 'DELETE';
    v_descripcion := 'Se eliminó el proveedor: ' ||
                     'ID=' || :OLD.ID_PROVEEDOR || ', ' ||
...
BEGIN
  IF INSERTING THEN
    v_operacion := 'INSERT';
    v_descripcion := 'Se insertó un teléfono de cliente: ' ||
  ...
  ELSIF UPDATING THEN
    v_operacion := 'UPDATE';
    v_descripcion := 'Se actualizó el teléfono ID=' || :OLD.ID_TELEFONO || ' ? ' ||
                     'ANTES [TELEFONO=' || :OLD.TELEFONO || ', ID_CLIENTE=' || :OLD.ID_CLIENTE || '] ? ' ||
                     'DESPUÉS [TELEFONO=' || :NEW.TELEFONO || ', ID_CLIENTE=' || :NEW.ID_CLIENTE || ']';

  ELSIF DELETING THEN
    v_operacion := 'DELETE';
    v_descripcion := 'Se eliminó el teléfono de cliente: ' ||
...
BEGIN
  IF INSERTING THEN
    v_operacion := 'INSERT';
    v_descripcion := 'Se insertó un teléfono de proveedor: ' ||
                     'ID_TELEFONO=' || :NEW.ID_TELEFONO || ', ' ||
                     'TELEFONO=' || :NEW.TELEFONO || ', ' ||
                     'ID_PROVEEDOR=' || :NEW.ID_PROVEEDOR;
  ...
  ELSIF UPDATING THEN
    ...
    v_descripcion := 'Se actualizó el teléfono ID=' || :OLD.ID_TELEFONO || ' ? ' ||
                     ...
                     'DESPUÉS [TELEFONO=' || :NEW.TELEFONO || ', ID_PROVEEDOR=' || :NEW.ID_PROVEEDOR || ']';

  ELSIF DELETING THEN
    v_operacion := 'DELETE';
    v_descripcion := 'Se eliminó el teléfono de proveedor: ' ||
                     'ID_TELEFONO=' || :OLD.ID_TELEFONO || ', ' ||
                     'TELEFONO=' || :OLD.TELEFONO || ', ' ||
...
BEGIN
  IF INSERTING THEN
    v_operacion := 'INSERT';
    v_descripcion := 'Se insertó la categoría: ' ||
                     'ID=' || :NEW.ID_CATEGORIA || ', ' ||
                     'NOMBRE=' || :NEW.NOMBRE_CATEGORIA;

  ELSIF UPDATING THEN
    v_operacion := 'UPDATE';
    v_descripcion := 'Se actualizó la categoría ID=' || :OLD.ID_CATEGORIA || ' ? ' ||
                     'ANTES [NOMBRE=' || :OLD.NOMBRE_CATEGORIA || '] ? ' ||
                     'DESPUÉS [NOMBRE=' || :NEW.NOMBRE_CATEGORIA || ']';

  ELSIF DELETING THEN
    v_operacion := 'DELETE';
    v_descripcion := 'Se eliminó la categoría: ' ||
                     'ID=' || :OLD.ID_CATEGORIA || ', ' ||
...
BEGIN
    ...
    RETURN 1;  -- el proveedor s� tiene productos vendidos
EXCEPTION
    WHEN NO_DATA_FOUND THEN
        RETURN 0; 
    WHEN OTHERS THEN
