...
-- Crear USUARIOS y asignar roles y tablespaces
...
-- Privilegios directos necesarios para ejecutar DDL din√°mico desde PL/SQL
...
-- OJO DESDE AQUI SE EMPIEZA A EJECUTAR DESDE EL ESQUEMA BETAGROUP
...
-- Crear tabla de TELEFONO_PROVEEDOR
...
BEGIN
  -- Convierte la contrase√Ø¬ø¬Ωa a un hash SHA-256 y lo devuelve en hexadecimal
  RETURN RAWTOHEX(
    DBMS_CRYPTO.HASH(
...
CREATE OR REPLACE PROCEDURE PROC_VALIDAR_LOGIN (
    ...
    v_hash VARCHAR2(64);
BEGIN
    -- Hash de la contrase√Ø¬ø¬Ωa ingresada
    ...
    p_resultado := 1; -- login v√Ø¬ø¬Ωlido
...
CREATE OR REPLACE PROCEDURE PROC_CREAR_AUTOINCREMENTO (
    ...
    v_seq_name    VARCHAR2(100);     -- nombre que se usar√Ø¬ø¬Ω para la secuencia
    v_trigger_name VARCHAR2(100);    -- nombre que se usar√Ø¬ø¬Ω para el trigger
BEGIN
    ...
    -- Intentamos eliminar la secuencia anterior (si ya exist√Ø¬ø¬Ωa), para evitar errores
    EXECUTE IMMEDIATE '
        BEGIN
    ...
    -- Creamos la nueva secuencia desde 1, que se usar√Ø¬ø¬Ω para generar los IDs
    EXECUTE IMMEDIATE '
    ...
    -- Creamos el trigger que se ejecuta autom√Ø¬ø¬Ωticamente antes de cada INSERT
...
BEGIN
    ...
    IF SQL%ROWCOUNT = 0 THEN
        RAISE_APPLICATION_ERROR(-20003, 'No se encontrÛ el usuario a actualizar.');
    END IF;
EXCEPTION
    WHEN OTHERS THEN
...
-- 7. Procedimiento para actualizar usuario sin contraseÒa
...
BEGIN
    ...
    IF SQL%ROWCOUNT = 0 THEN
        RAISE_APPLICATION_ERROR(-20005, 'No se encontrÛ el usuario a actualizar.');
    END IF;
EXCEPTION
    WHEN OTHERS THEN
...
BEGIN
    ...
    IF SQL%ROWCOUNT = 0 THEN
        RAISE_APPLICATION_ERROR(-20007, 'No se encontrÛ el usuario a eliminar.');
    END IF;
EXCEPTION
    WHEN OTHERS THEN
...
BEGIN
    ...
    IF SQL%ROWCOUNT = 0 THEN
        RAISE_APPLICATION_ERROR(-20011, 'No se encontrÛ el cliente a actualizar.');
    END IF;
EXCEPTION
    WHEN OTHERS THEN
...
BEGIN
    ...
    IF SQL%ROWCOUNT = 0 THEN
        RAISE_APPLICATION_ERROR(-20013, 'No se encontrÛ el cliente a eliminar.');
    END IF;
EXCEPTION
    WHEN OTHERS THEN
...
EXCEPTION
    WHEN DUP_VAL_ON_INDEX THEN
        RAISE_APPLICATION_ERROR(-20016, 'La clÌnica ya existe.');
    WHEN OTHERS THEN
        RAISE_APPLICATION_ERROR(-20017, 'Error al insertar clÌnica: ' || SQLERRM);
END;
/
...
BEGIN
    ...
    IF SQL%ROWCOUNT = 0 THEN
        RAISE_APPLICATION_ERROR(-20018, 'No se encontrÛ la clÌnica a actualizar.');
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE_APPLICATION_ERROR(-20019, 'Error al actualizar clÌnica: ' || SQLERRM);
END;
/
...
BEGIN
    ...
    IF SQL%ROWCOUNT = 0 THEN
        RAISE_APPLICATION_ERROR(-20020, 'No se encontrÛ la clÌnica a eliminar.');
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE_APPLICATION_ERROR(-20021, 'Error al eliminar clÌnica: ' || SQLERRM);
END;
/
...
EXCEPTION
    WHEN OTHERS THEN
        RAISE_APPLICATION_ERROR(-20022, 'Error al listar clÌnicas: ' || SQLERRM);
END;
/
...
EXCEPTION
    WHEN OTHERS THEN
        RAISE_APPLICATION_ERROR(-20005, 'Error al listar categorÌas: ' || SQLERRM);
END;
/
...
EXCEPTION
    WHEN OTHERS THEN
        RAISE_APPLICATION_ERROR(-20006, 'Error al insertar categorÌa: ' || SQLERRM);
END;
/
...
EXCEPTION
    WHEN OTHERS THEN
        RAISE_APPLICATION_ERROR(-20007, 'Error al eliminar categorÌa: ' || SQLERRM);
END;
/
...
BEGIN
    ...
    IF SQL%ROWCOUNT = 0 THEN
        RAISE_APPLICATION_ERROR(-20026, 'No se encontrÛ el proveedor a actualizar');
    END IF;
EXCEPTION
    WHEN OTHERS THEN
...
BEGIN
    -- Eliminar telÈfonos vinculados a este proveedor
    ...
    IF SQL%ROWCOUNT = 0 THEN
        RAISE_APPLICATION_ERROR(-20028, 'No se encontrÛ el proveedor a eliminar');
    END IF;
EXCEPTION
    WHEN OTHERS THEN
...
BEGIN
    ...
    IF SQL%ROWCOUNT = 0 THEN
        RAISE_APPLICATION_ERROR(-20030, 'No se encontrÛ el proveedor a habilitar');
    END IF;
EXCEPTION
    WHEN OTHERS THEN
...
EXCEPTION
    WHEN OTHERS THEN
        RAISE_APPLICATION_ERROR(-20033, 'Error al obtener IDs de telÈfonos: ' || SQLERRM);
END;
/

-- 31. Procedimiento para obtener telÈfonos completos de un proveedor
...
EXCEPTION
    WHEN OTHERS THEN
        RAISE_APPLICATION_ERROR(-20034, 'Error al obtener telÈfonos: ' || SQLERRM);
END;
/
...
BEGIN
    ...
    IF SQL%ROWCOUNT = 0 THEN
        RAISE_APPLICATION_ERROR(-20035, 'No se encontrÛ el telÈfono a actualizar');
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE_APPLICATION_ERROR(-20036, 'Error al actualizar telÈfono: ' || SQLERRM);
END;
/

-- 33. Procedimiento para eliminar un telÈfono
...
BEGIN
    ...
    IF SQL%ROWCOUNT = 0 THEN
        RAISE_APPLICATION_ERROR(-20037, 'No se encontrÛ el telÈfono a eliminar');
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE_APPLICATION_ERROR(-20038, 'Error al eliminar telÈfono: ' || SQLERRM);
END;
/
...
EXCEPTION
    WHEN OTHERS THEN
        RAISE_APPLICATION_ERROR(-20039, 'Error al insertar telÈfono: ' || SQLERRM);
END;
/
...
BEGIN
    ...
    IF SQL%ROWCOUNT = 0 THEN
        RAISE_APPLICATION_ERROR(-20040, 'No se encontrÛ la venta a eliminar');
    END IF;
EXCEPTION
    WHEN OTHERS THEN
...
BEGIN
    ...
    IF SQL%ROWCOUNT = 0 THEN
        RAISE_APPLICATION_ERROR(-20042, 'No se encontrÛ el detalle de venta a eliminar');
    END IF;
EXCEPTION
    WHEN OTHERS THEN
...
EXCEPTION
    WHEN DUP_VAL_ON_INDEX THEN
        RAISE_APPLICATION_ERROR(-20002, 'N˙mero de venta ya existe');
    WHEN OTHERS THEN
...
EXCEPTION
    WHEN OTHERS THEN
        RAISE_APPLICATION_ERROR(-20005, 'Error al obtener n˙mero m·ximo de venta: ' || SQLERRM);
END;
/
...
--43. Procedimiento que devuelve la ultima venta ingresada
...
EXCEPTION
    WHEN OTHERS THEN
        RAISE_APPLICATION_ERROR(-20008, 'Error al obtener ˙ltimo ID de venta: ' || SQLERRM);
END;
/

--44. Procedimiento que obtiene un producto a partir de un id
...
-- 48. Procedimiento para obtener telÈfonos de un cliente
...
-- 49. Procedimiento para obtener solo los IDs de telÈfono de un cliente
...
EXCEPTION
    WHEN NO_DATA_FOUND THEN
        RAISE_APPLICATION_ERROR(-20002, 'No se encontraron clientes para el tipo de clÌnica ' || p_id_tipo_clinica);
    WHEN OTHERS THEN
        RAISE_APPLICATION_ERROR(-20003, 'Error al obtener clientes por clÌnica: ' || SQLERRM);
END;
/
...
BEGIN
  IF INSERTING THEN
    v_operacion := 'INSERT';
    v_descripcion := 'Se insert√Ø¬ø¬Ω el producto: ' ||
                     'ID=' || :NEW.ID_PRODUCTO || ', ' ||
  ...
  ELSIF UPDATING THEN
    v_operacion := 'UPDATE';
    v_descripcion := 'Se actualiz√Ø¬ø¬Ω el producto ID=' || :OLD.ID_PRODUCTO || ' ? ' ||
                     'ANTES [NOMBRE=' || :OLD.NOMBRE_PRODUCTO || ', PRECIO=' || :OLD.PRECIO || '] ? ' ||
                     'DESPU√Ø¬ø¬ΩS [NOMBRE=' || :NEW.NOMBRE_PRODUCTO || ', PRECIO=' || :NEW.PRECIO || ']';

  ELSIF DELETING THEN
    v_operacion := 'DELETE';
    v_descripcion := 'Se elimin√Ø¬ø¬Ω el producto: ' ||
                     'ID=' || :OLD.ID_PRODUCTO || ', ' ||
...
BEGIN
  IF INSERTING THEN
    v_operacion := 'INSERT';
    v_descripcion := 'Se insert√≥ la venta: ' ||
                     'ID=' || :NEW.ID_VENTA || ', ' ||
                     'NUMERO=' || :NEW.NUMERO || ', ' ||
  ...
  ELSIF UPDATING THEN
    v_operacion := 'UPDATE';
    v_descripcion := 'Se actualiz√≥ la venta ID=' || :OLD.ID_VENTA || ' ? ' ||
                     'ANTES [NUMERO=' || :OLD.NUMERO || ', IMPUESTOS=' || :OLD.IMPUESTOS || '] ? ' ||
                     'DESPU√âS [NUMERO=' || :NEW.NUMERO || ', IMPUESTOS=' || :NEW.IMPUESTOS || ']';

  ELSIF DELETING THEN
    v_operacion := 'DELETE';
    v_descripcion := 'Se elimin√≥ la venta: ' ||
                     'ID=' || :OLD.ID_VENTA || ', ' ||
                     'NUMERO=' || :OLD.NUMERO || ', ' ||
...
BEGIN
  IF INSERTING THEN
    v_operacion := 'INSERT';
    v_descripcion := 'Se insert√≥ el detalle de venta: ' ||
  ...
  ELSIF UPDATING THEN
    v_operacion := 'UPDATE';
    v_descripcion := 'Se actualiz√≥ el detalle de venta ID=' || :OLD.ID_VENTA_DETALLE || ' ? ' ||
                     'ANTES [CANTIDAD=' || :OLD.CANTIDAD || ', PRECIO_UNITARIO=' || :OLD.PRECIO_UNITARIO || ', DESCUENTO=' || :OLD.DESCUENTO || '] ? ' ||
                     'DESPU√âS [CANTIDAD=' || :NEW.CANTIDAD || ', PRECIO_UNITARIO=' || :NEW.PRECIO_UNITARIO || ', DESCUENTO=' || :NEW.DESCUENTO || ']';

  ELSIF DELETING THEN
    v_operacion := 'DELETE';
    v_descripcion := 'Se elimin√≥ el detalle de venta: ' ||
...
BEGIN
  IF INSERTING THEN
    v_operacion := 'INSERT';
    v_descripcion := 'Se insert√≥ el usuario: ' ||
                     'ID=' || :NEW.ID_USUARIO || ', ' ||
  ...
  ELSIF UPDATING THEN
    v_operacion := 'UPDATE';
    v_descripcion := 'Se actualiz√≥ el usuario ID=' || :OLD.ID_USUARIO || ' ? ' ||
                     'ANTES [NOMBRE=' || :OLD.NOMBRE_USUARIO || ', CORREO=' || :OLD.CORREO || ', ROL=' || :OLD.ROL || '] ? ' ||
                     'DESPU√âS [NOMBRE=' || :NEW.NOMBRE_USUARIO || ', CORREO=' || :NEW.CORREO || ', ROL=' || :NEW.ROL || ']';

  ELSIF DELETING THEN
    v_operacion := 'DELETE';
    v_descripcion := 'Se elimin√≥ el usuario: ' ||
                     'ID=' || :OLD.ID_USUARIO || ', ' ||
...
BEGIN
  IF INSERTING THEN
    v_operacion := 'INSERT';
    v_descripcion := 'Se insert√≥ el cliente: ' ||
                     'ID=' || :NEW.ID_CLIENTE || ', ' ||
  ...
  ELSIF UPDATING THEN
    v_operacion := 'UPDATE';
    v_descripcion := 'Se actualiz√≥ el cliente ID=' || :OLD.ID_CLIENTE || ' ? ' ||
                     'ANTES [NOMBRE=' || :OLD.NOMBRE_CLIENTE || ', CORREO=' || :OLD.CORREO || ', TIPO=' || :OLD.ID_TIPO_CLINICA || '] ? ' ||
                     'DESPU√âS [NOMBRE=' || :NEW.NOMBRE_CLIENTE || ', CORREO=' || :NEW.CORREO || ', TIPO=' || :NEW.ID_TIPO_CLINICA || ']';

  ELSIF DELETING THEN
    v_operacion := 'DELETE';
    v_descripcion := 'Se elimin√≥ el cliente: ' ||
                     'ID=' || :OLD.ID_CLIENTE || ', ' ||
...
BEGIN
  IF INSERTING THEN
    v_operacion := 'INSERT';
    v_descripcion := 'Se insert√≥ el tipo de cl√≠nica: ' ||
                     'ID=' || :NEW.ID_TIPO_CLINICA || ', ' ||
                     'DESCRIPCION=' || :NEW.DESCRIPCION;

  ELSIF UPDATING THEN
    v_operacion := 'UPDATE';
    v_descripcion := 'Se actualiz√≥ el tipo de cl√≠nica ID=' || :OLD.ID_TIPO_CLINICA || ' ? ' ||
                     'ANTES [DESCRIPCION=' || :OLD.DESCRIPCION || '] ? ' ||
                     'DESPU√âS [DESCRIPCION=' || :NEW.DESCRIPCION || ']';

  ELSIF DELETING THEN
    v_operacion := 'DELETE';
    v_descripcion := 'Se elimin√≥ el tipo de cl√≠nica: ' ||
...
--2. Funcion para determinar si el proveedor tiene ventas
...
BEGIN
    ...
    RETURN 1;  -- el proveedor sÌ tiene productos vendidos
EXCEPTION
    WHEN NO_DATA_FOUND THEN
        RETURN 0; 
    WHEN OTHERS THEN
...
-- 3. Funcion para determinar si el producto tiene ventas
...
BEGIN
    ...
    RETURN 1; -- El producto est· en alguna venta
EXCEPTION
    WHEN NO_DATA_FOUND THEN
...
-- 4. Funcion para determinar si el cliente tiene ventas
...
-- 5. Funcion para reporte de ventas
...
--6. Funcion para detalle de ventas
...
--7. Funcion para total de ventas
...
BEGIN
    OPEN v_cursor FOR
        SELECT
            NVL(SUM(D.CANTIDAD * D.PRECIO_UNITARIO), 0) AS SUBTOTAL,
            NVL(SUM(D.CANTIDAD * D.PRECIO_UNITARIO * (D.DESCUENTO / 100)), 0) AS DESCUENTO_TOTAL,
            NVL(SUM(D.CANTIDAD * D.PRECIO_UNITARIO * (1 - D.DESCUENTO / 100)), 0) AS TOTAL
        FROM VENTA_DETALLE D
        WHERE D.ID_VENTA = p_id_venta;
...
--8. Funcion para informacion de ventas
...
-- -------------------------- INSERCI√ìN DE USUARIOS ------------------------------------------------------
-- Insertamos datos en la tabla USUARIO
-- No se especifica ID_USUARIO porque se genera automaticamente por el trigger
-- La contrase√Ø¬ø¬Ωa se guarda encriptada con HASH_PASSWORD
...
-- -------------------------- INSERCI√ìN DE PROVEEDORES ------------------------------------------------------

INSERT INTO PROVEEDOR ( NOMBRE_PROVEEDOR, CORREO, DIRECCION_PROVEEDOR, FECHA_REGISTRO)
  VALUES ( 'Distribuidora M√©dica Central', 'contacto@dismedicentral.com', 'San Jos√© centro', SYSDATE);
  INSERT INTO PROVEEDOR ( NOMBRE_PROVEEDOR, CORREO, DIRECCION_PROVEEDOR, FECHA_REGISTRO)
  ...
  INSERT INTO PROVEEDOR ( NOMBRE_PROVEEDOR, CORREO, DIRECCION_PROVEEDOR, FECHA_REGISTRO)
  VALUES ( 'Proveedora Vida', 'vida@proveedora.com', 'San Ram√≥n centro', SYSDATE);
  INSERT INTO PROVEEDOR ( NOMBRE_PROVEEDOR, CORREO, DIRECCION_PROVEEDOR, FECHA_REGISTRO)
  ...
  INSERT INTO PROVEEDOR ( NOMBRE_PROVEEDOR, CORREO, DIRECCION_PROVEEDOR, FECHA_REGISTRO)
  VALUES ( 'Salud XXI', 'info@saludxxi.cr', 'Perez Zeled√≥n, Daniel Flores', SYSDATE);
  INSERT INTO PROVEEDOR ( NOMBRE_PROVEEDOR, CORREO, DIRECCION_PROVEEDOR, FECHA_REGISTRO)
  ...
  INSERT INTO PROVEEDOR ( NOMBRE_PROVEEDOR, CORREO, DIRECCION_PROVEEDOR, FECHA_REGISTRO)
  VALUES ( 'VitalCare', 'ventas@vitalcare.net', 'San Isidro, P√©rez Zeled√≥n', SYSDATE);
  INSERT INTO PROVEEDOR ( NOMBRE_PROVEEDOR, CORREO, DIRECCION_PROVEEDOR, FECHA_REGISTRO)
  VALUES ( 'FarmaL√≥gica', 'soporte@farmalogica.com', 'Cartago, Occidental', SYSDATE);
  INSERT INTO PROVEEDOR ( NOMBRE_PROVEEDOR, CORREO, DIRECCION_PROVEEDOR, FECHA_REGISTRO)
  VALUES ('Grupo PharmaVida', 'contacto@pharmavida.com', 'San Jos√©, La Uruca', SYSDATE);
  INSERT INTO PROVEEDOR ( NOMBRE_PROVEEDOR, CORREO, DIRECCION_PROVEEDOR, FECHA_REGISTRO)
  VALUES ('SaludTica', 'info@saludtica.org', 'Escaz√∫, Trejos Montealegre', SYSDATE);
  INSERT INTO PROVEEDOR ( NOMBRE_PROVEEDOR, CORREO, DIRECCION_PROVEEDOR, FECHA_REGISTRO)
  ...
  INSERT INTO PROVEEDOR ( NOMBRE_PROVEEDOR, CORREO, DIRECCION_PROVEEDOR, FECHA_REGISTRO)
  VALUES ('Insumos M√©dicos JJ', 'jj@insumed.com', 'Orotina, centro', SYSDATE);
  INSERT INTO PROVEEDOR ( NOMBRE_PROVEEDOR, CORREO, DIRECCION_PROVEEDOR, FECHA_REGISTRO)
  VALUES ('FarmaPlus', 'soporte@farmaplus.com', 'Bel√©n, Cariari', SYSDATE);
  INSERT INTO PROVEEDOR ( NOMBRE_PROVEEDOR, CORREO, DIRECCION_PROVEEDOR, FECHA_REGISTRO)
  VALUES ('Droguer√≠a Vital', 'ventas@drogvital.com', 'V√°squez de Coronado', SYSDATE);
  INSERT INTO PROVEEDOR ( NOMBRE_PROVEEDOR, CORREO, DIRECCION_PROVEEDOR, FECHA_REGISTRO)
  VALUES ('RedSalud', 'red@salud.com', 'San Jos√©, Zapote', SYSDATE);
  INSERT INTO PROVEEDOR ( NOMBRE_PROVEEDOR, CORREO, DIRECCION_PROVEEDOR, FECHA_REGISTRO)
  ...
  INSERT INTO PROVEEDOR ( NOMBRE_PROVEEDOR, CORREO, DIRECCION_PROVEEDOR, FECHA_REGISTRO)
  VALUES ('MediLink S.A.', 'soporte@medilink.com', 'Aserr√≠, centro', SYSDATE);
  INSERT INTO PROVEEDOR ( NOMBRE_PROVEEDOR, CORREO, DIRECCION_PROVEEDOR, FECHA_REGISTRO)
  VALUES ('VitalTech', 'info@vitaltech.org', 'Ca√±as, Guanacaste', SYSDATE);
  INSERT INTO PROVEEDOR ( NOMBRE_PROVEEDOR, CORREO, DIRECCION_PROVEEDOR, FECHA_REGISTRO)
  VALUES ('Eficiencia M√©dica', 'eficiencia@medica.cr', 'Naranjo, centro', SYSDATE);
  INSERT INTO PROVEEDOR ( NOMBRE_PROVEEDOR, CORREO, DIRECCION_PROVEEDOR, FECHA_REGISTRO)
  ...
  INSERT INTO PROVEEDOR ( NOMBRE_PROVEEDOR, CORREO, DIRECCION_PROVEEDOR, FECHA_REGISTRO)
  VALUES ('Salud Moderna', 'modernasalud@correo.com', 'Tib√°s, centro', SYSDATE);
  INSERT INTO PROVEEDOR ( NOMBRE_PROVEEDOR, CORREO, DIRECCION_PROVEEDOR, FECHA_REGISTRO)
  ...
  INSERT INTO PROVEEDOR ( NOMBRE_PROVEEDOR, CORREO, DIRECCION_PROVEEDOR, FECHA_REGISTRO)
  VALUES ('Insum√©dica', 'contacto@insumedica.com', 'La Uni√≥n, Tres R√≠os', SYSDATE);
  INSERT INTO PROVEEDOR ( NOMBRE_PROVEEDOR, CORREO, DIRECCION_PROVEEDOR, FECHA_REGISTRO)
  VALUES ('MediPlus Internacional', 'info@mediplus.com', 'Zarcero, Alajuela', SYSDATE);
  INSERT INTO PROVEEDOR ( NOMBRE_PROVEEDOR, CORREO, DIRECCION_PROVEEDOR, FECHA_REGISTRO)
  VALUES ('FarmaStore', 'ventas@farmastore.com', 'Po√°s, Alajuela', SYSDATE);
  INSERT INTO PROVEEDOR ( NOMBRE_PROVEEDOR, CORREO, DIRECCION_PROVEEDOR, FECHA_REGISTRO)
  VALUES ('VitaRed CR', 'vitar@correo.com', 'Siquirres, centro', SYSDATE);
  INSERT INTO PROVEEDOR ( NOMBRE_PROVEEDOR, CORREO, DIRECCION_PROVEEDOR, FECHA_REGISTRO)
  VALUES ('TecniFarma', 'admin@tecnifarma.com', 'Tilar√°n, Guanacaste', SYSDATE);
  INSERT INTO PROVEEDOR ( NOMBRE_PROVEEDOR, CORREO, DIRECCION_PROVEEDOR, FECHA_REGISTRO)
  ...
  INSERT INTO PROVEEDOR ( NOMBRE_PROVEEDOR, CORREO, DIRECCION_PROVEEDOR, FECHA_REGISTRO)
  VALUES ('BioVida', 'info@biovida.com', 'Gu√°cimo, Lim√≥n', SYSDATE);
  INSERT INTO PROVEEDOR ( NOMBRE_PROVEEDOR, CORREO, DIRECCION_PROVEEDOR, FECHA_REGISTRO)
  ...
  INSERT INTO PROVEEDOR ( NOMBRE_PROVEEDOR, CORREO, DIRECCION_PROVEEDOR, FECHA_REGISTRO)
  VALUES ('Grupo Vital Am√©rica', 'america@vital.com', 'Osa, Palmar Norte', SYSDATE);
  INSERT INTO PROVEEDOR ( NOMBRE_PROVEEDOR, CORREO, DIRECCION_PROVEEDOR, FECHA_REGISTRO)
  ...
  INSERT INTO PROVEEDOR ( NOMBRE_PROVEEDOR, CORREO, DIRECCION_PROVEEDOR, FECHA_REGISTRO)
  VALUES ('FarmaLink', 'flink@ventas.com', 'Jim√©nez, Gu√°piles', SYSDATE);
  INSERT INTO PROVEEDOR ( NOMBRE_PROVEEDOR, CORREO, DIRECCION_PROVEEDOR, FECHA_REGISTRO)
  VALUES ('Ecosalud', 'eco@saludverde.com', 'Matina, Lim√≥n', SYSDATE);
  INSERT INTO PROVEEDOR ( NOMBRE_PROVEEDOR, CORREO, DIRECCION_PROVEEDOR, FECHA_REGISTRO)
  VALUES ('TecnoInsumos', 'tecno@insumos.com', 'Talamanca, Bribr√≠', SYSDATE);
  INSERT INTO PROVEEDOR ( NOMBRE_PROVEEDOR, CORREO, DIRECCION_PROVEEDOR, FECHA_REGISTRO)
  ...
  INSERT INTO PROVEEDOR ( NOMBRE_PROVEEDOR, CORREO, DIRECCION_PROVEEDOR, FECHA_REGISTRO)
  VALUES ('SaniTech', 'contacto@sanitech.com', 'Pococ√≠, centro', SYSDATE);
  INSERT INTO PROVEEDOR ( NOMBRE_PROVEEDOR, CORREO, DIRECCION_PROVEEDOR, FECHA_REGISTRO)
  VALUES ('Grupo BioInsumos', 'bio@grupoinsumos.com', 'Lim√≥n centro', SYSDATE);
...
INSERT INTO TIPO_CLINICA (DESCRIPCION) VALUES ('Cl nica General');
...
INSERT INTO CLIENTE  (NOMBRE_CLIENTE, CORREO, ID_TIPO_CLINICA)  VALUES ( 'Jimena Blanco', 'jblanco@medicos.com', 1);
