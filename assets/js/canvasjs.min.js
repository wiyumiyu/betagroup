...
(function () {
    ...
    function eb(h, n) {
        var E = this.length >>> 0, r = Number(n) || 0, r = 0 > r ? Math.ceil(r) : Math.floor(r);
        for (0 > r && (r += E); r < E; r++)
    ...
    function J(h, n) {
        var E = [];
        if (E = {solid: [], shortDash: [3, 1], shortDot: [1, 1], shortDashDot: [3, 1, 1, 1], shortDashDotDot: [3, 1, 1, 1, 1, 1], dot: [1, 2], dash: [4, 2], dashDot: [4, 2, 1, 2], longDash: [8,
                2], longDashDot: [8, 2, 1, 2], longDashDotDot: [8, 2, 1, 2, 1, 2]}[h || "solid"])
    ...
    function hb(h) {
        if (h._menuButton)
            ...
            K(h._menuButton, "mouseout", function () {
                n || (S(h._menuButton, {backgroundColor: h.toolbar.itemBackgroundColor,
                    color: h.toolbar.fontColor}), 0 >= navigator.userAgent.search("MSIE") && S(h._menuButton.childNodes[0], {WebkitFilter: "invert(0%)", filter: "invert(0%)"}))
            }, h.allDOMEventHandlers, !0)
        }
        if (h.exportEnabled && h._dropdownMenu) {
            ...
            for (var E = h._dropdownMenu.childNodes, r = [h._cultureInfo.printText, h._cultureInfo.saveJPGText, h._cultureInfo.savePNGText], sa = 0; sa < E.length; sa++)
                S(E[sa], {backgroundColor: h.toolbar.itemBackgroundColor,
                    color: h.toolbar.fontColor}), E[sa].innerHTML = r[sa]
        } else
            !h._dropdownMenu && (h.exportEnabled && w) && (n = !1, h._dropdownMenu = document.createElement("div"), h._dropdownMenu.setAttribute("tabindex", -1), E = -1 !== h.theme.indexOf("dark") ? "black" : "#888888", S(h._dropdownMenu, {position: "absolute", zIndex: 1, userSelect: "none", MozUserSeelct: "none", WebkitUserSelect: "none", msUserSelect: "none", cursor: "pointer", right: "0px", top: "25px", minWidth: "120px", outline: 0, fontSize: "14px", fontFamily: "Arial, Helvetica, sans-serif", padding: "5px 0px 5px 0px",
                textAlign: "left", lineHeight: "10px", backgroundColor: h.toolbar.itemBackgroundColor, boxShadow: "2px 2px 10px" + E}), h._dropdownMenu.style.display = "none", h._toolBar.appendChild(h._dropdownMenu), K(h._dropdownMenu, "blur", function () {
                ua(h._dropdownMenu);
            ...
            }, h.allDOMEventHandlers, !0), K(E, "mouseout", function () {
                ...
                ua(h._dropdownMenu)
                    ...
                    E.innerHTML = h._cultureInfo.saveJPGText, E.style.backgroundColor = h.toolbar.itemBackgroundColor, E.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(E), K(E, "touchstart", function (h) {
                n = !0
            }, h.allDOMEventHandlers), K(E, "mousemove", function () {
                n || (this.style.backgroundColor = h.toolbar.itemBackgroundColorOnHover, this.style.color = h.toolbar.fontColorOnHover)
            }, h.allDOMEventHandlers, !0), K(E, "mouseout", function () {
                ...
                ua(h._dropdownMenu)
            }, h.allDOMEventHandlers, !0), E = document.createElement("div"), S(E, {padding: "12px 8px 12px 8px"}), E.innerHTML = h._cultureInfo.savePNGText, E.style.backgroundColor = h.toolbar.itemBackgroundColor, E.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(E), K(E, "touchstart", function (h) {
                n = !0
            }, h.allDOMEventHandlers), K(E, "mousemove", function () {
    ...
    function ib(h) {
        if (!jb) {
            ...
            if (h.creditHref && h.creditText) {
                h._creditLink || (h._creditLink = document.createElement("a"), h._creditLink.setAttribute("class", "canvasjs-chart-credit"), h._creditLink.setAttribute("title", "JavaScript Charts"), S(h._creditLink, {outline: "none", margin: "0px", position: "absolute", right: "2px", top: h.height - 14 + "px", color: "dimgrey", textDecoration: "none",
                    fontSize: "11px", fontFamily: "Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif"}), h._creditLink.setAttribute("tabIndex", -1), h._creditLink.setAttribute("target", "_blank"));
    ...
    function pa(h, n, E) {
        n.getAttribute("state") || (n.style.backgroundColor = h.toolbar.itemBackgroundColor, n.style.color = h.toolbar.fontColor, n.style.border = "none", S(n, {WebkitUserSelect: "none",
        ...
        if (r(this.options.margin) && h.options.subtitles)
            for (var E = h.options.subtitles, w = 0; w < E.length; w++)
                if ((r(E[w].horizontalAlign) && "center" === this.horizontalAlign || E[w].horizontalAlign === this.horizontalAlign) && (r(E[w].verticalAlign) && "top" === this.verticalAlign || E[w].verticalAlign ===
                        this.verticalAlign) && !E[w].dockInsidePlotArea === !this.dockInsidePlotArea) {
                    this.margin = 0;
                    break
                }
    ...
    var Ia = !1, ta = {}, w = !!document.createElement("canvas").getContext, oa = {Chart: {width: 500, height: 400, zoomEnabled: !1, zoomType: "x", backgroundColor: "white", theme: "light1", animationEnabled: !1, animationDuration: 1200, dataPointWidth: null, dataPointMinWidth: null,
            ...
            months: "January February March April May June July August September October November December".split(" "), shortMonths: "Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" ")}}, La = {en: {}}, v = w ? "Trebuchet MS, Helvetica, sans-serif" : "Arial", Ga = w ? "Impact, Charcoal, sans-serif" : "Arial", za = {colorSet1: "#4F81BC #C0504E #9BBB58 #23BFAA #8064A1 #4AACC5 #F79647 #7F6084 #77A033 #33558B #E59566".split(" "), colorSet2: "#6D78AD #51CDA0 #DF7970 #4C9CA0 #AE7D99 #C9D45C #5592AD #DF874D #52BCA8 #8E7AA3 #E3CB64 #C77B85 #C39762 #8DD17E #B57952 #FCC26C".split(" "),
        colorSet3: "#8CA1BC #36845C #017E82 #8CB9D0 #708C98 #94838D #F08891 #0366A7 #008276 #EE7757 #E5BA3A #F2990B #03557B #782970".split(" ")}, R, Y, V, ea, ja;
    Y = "#333333";
    V = "#000000";
    R = "#666666";
    ja = ea = "#000000";
    var da = 20, B = 14, Wa = {colorSet: "colorSet1", backgroundColor: "#FFFFFF", title: {fontFamily: Ga, fontSize: 32, fontColor: Y, fontWeight: "normal", verticalAlign: "top", margin: 5}, subtitles: [{fontFamily: Ga, fontSize: B, fontColor: Y, fontWeight: "normal", verticalAlign: "top", margin: 5}], data: [{indexLabelFontFamily: v, indexLabelFontSize: B,
                indexLabelFontColor: Y, indexLabelFontWeight: "normal", indexLabelLineThickness: 1}], axisX: [{titleFontFamily: v, titleFontSize: da, titleFontColor: Y, titleFontWeight: "normal", labelFontFamily: v, labelFontSize: B, labelFontColor: V, labelFontWeight: "normal", lineThickness: 1, lineColor: R, tickThickness: 1, tickColor: R, gridThickness: 0, gridColor: R, stripLines: [{labelFontFamily: v, labelFontSize: B, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1}], crosshair: {labelFontFamily: v,
                    labelFontSize: B, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: ja, color: ea, thickness: 1, lineDashType: "dash"}, scaleBreaks: {type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1, lineDashType: "solid"}}], axisX2: [{titleFontFamily: v, titleFontSize: da, titleFontColor: Y, titleFontWeight: "normal", labelFontFamily: v, labelFontSize: B, labelFontColor: V, labelFontWeight: "normal", lineThickness: 1, lineColor: R, tickThickness: 1, tickColor: R, gridThickness: 0, gridColor: R, stripLines: [{labelFontFamily: v,
                        labelFontSize: B, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1}], crosshair: {labelFontFamily: v, labelFontSize: B, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: ja, color: ea, thickness: 1, lineDashType: "dash"}, scaleBreaks: {type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1, lineDashType: "solid"}}], axisY: [{titleFontFamily: v, titleFontSize: da, titleFontColor: Y, titleFontWeight: "normal", labelFontFamily: v, labelFontSize: B,
                labelFontColor: V, labelFontWeight: "normal", lineThickness: 1, lineColor: R, tickThickness: 1, tickColor: R, gridThickness: 1, gridColor: R, stripLines: [{labelFontFamily: v, labelFontSize: B, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1}], crosshair: {labelFontFamily: v, labelFontSize: B, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: ja, color: ea, thickness: 1, lineDashType: "dash"}, scaleBreaks: {type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1,
                    lineDashType: "solid"}}], axisY2: [{titleFontFamily: v, titleFontSize: da, titleFontColor: Y, titleFontWeight: "normal", labelFontFamily: v, labelFontSize: B, labelFontColor: V, labelFontWeight: "normal", lineThickness: 1, lineColor: R, tickThickness: 1, tickColor: R, gridThickness: 1, gridColor: R, stripLines: [{labelFontFamily: v, labelFontSize: B, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1}], crosshair: {labelFontFamily: v, labelFontSize: B, labelFontColor: "#EEEEEE", labelFontWeight: "normal",
                    labelBackgroundColor: ja, color: ea, thickness: 1, lineDashType: "dash"}, scaleBreaks: {type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1, lineDashType: "solid"}}], legend: {fontFamily: v, fontSize: 14, fontColor: Y, fontWeight: "bold", verticalAlign: "bottom", horizontalAlign: "center"}, toolTip: {fontFamily: v, fontSize: 14, fontStyle: "normal", cornerRadius: 0, borderThickness: 1}, toolbar: {itemBackgroundColor: "white", itemBackgroundColorOnHover: "#2196f3", buttonBorderColor: "#2196f3", buttonBorderThickness: 1, fontColor: "black",
    ...
    var da = 20, B = 14, bb = {colorSet: "colorSet2", title: {fontFamily: v, fontSize: 33, fontColor: "#3A3A3A", fontWeight: "bold", verticalAlign: "top", margin: 5}, subtitles: [{fontFamily: v, fontSize: B, fontColor: "#3A3A3A", fontWeight: "normal", verticalAlign: "top", margin: 5}], data: [{indexLabelFontFamily: v, indexLabelFontSize: B, indexLabelFontColor: "#666666", indexLabelFontWeight: "normal", indexLabelLineThickness: 1}], axisX: [{titleFontFamily: v, titleFontSize: da,
                titleFontColor: "#666666", titleFontWeight: "normal", labelFontFamily: v, labelFontSize: B, labelFontColor: "#666666", labelFontWeight: "normal", lineThickness: 1, lineColor: "#BBBBBB", tickThickness: 1, tickColor: "#BBBBBB", gridThickness: 1, gridColor: "#BBBBBB", stripLines: [{labelFontFamily: v, labelFontSize: B, labelFontColor: "#FFA500", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FFA500", thickness: 1}], crosshair: {labelFontFamily: v, labelFontSize: B, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: "black",
                    color: "black", thickness: 1, lineDashType: "dot"}, scaleBreaks: {type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1, lineDashType: "solid"}}], axisX2: [{titleFontFamily: v, titleFontSize: da, titleFontColor: "#666666", titleFontWeight: "normal", labelFontFamily: v, labelFontSize: B, labelFontColor: "#666666", labelFontWeight: "normal", lineThickness: 1, lineColor: "#BBBBBB", tickColor: "#BBBBBB", tickThickness: 1, gridThickness: 1, gridColor: "#BBBBBB", stripLines: [{labelFontFamily: v, labelFontSize: B, labelFontColor: "#FFA500",
                        labelFontWeight: "normal", labelBackgroundColor: null, color: "#FFA500", thickness: 1}], crosshair: {labelFontFamily: v, labelFontSize: B, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: "black", color: "black", thickness: 1, lineDashType: "dot"}, scaleBreaks: {type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1, lineDashType: "solid"}}], axisY: [{titleFontFamily: v, titleFontSize: da, titleFontColor: "#666666", titleFontWeight: "normal", labelFontFamily: v, labelFontSize: B, labelFontColor: "#666666",
                labelFontWeight: "normal", lineThickness: 0, lineColor: "#BBBBBB", tickColor: "#BBBBBB", tickThickness: 1, gridThickness: 1, gridColor: "#BBBBBB", stripLines: [{labelFontFamily: v, labelFontSize: B, labelFontColor: "#FFA500", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FFA500", thickness: 1}], crosshair: {labelFontFamily: v, labelFontSize: B, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: "black", color: "black", thickness: 1, lineDashType: "dot"}, scaleBreaks: {type: "zigzag", spacing: "2%", lineColor: "#BBBBBB",
                    lineThickness: 1, lineDashType: "solid"}}], axisY2: [{titleFontFamily: v, titleFontSize: da, titleFontColor: "#666666", titleFontWeight: "normal", labelFontFamily: v, labelFontSize: B, labelFontColor: "#666666", labelFontWeight: "normal", lineThickness: 0, lineColor: "#BBBBBB", tickColor: "#BBBBBB", tickThickness: 1, gridThickness: 1, gridColor: "#BBBBBB", stripLines: [{labelFontFamily: v, labelFontSize: B, labelFontColor: "#FFA500", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FFA500", thickness: 1}], crosshair: {labelFontFamily: v,
                    labelFontSize: B, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: "black", color: "black", thickness: 1, lineDashType: "dot"}, scaleBreaks: {type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1, lineDashType: "solid"}}], legend: {fontFamily: v, fontSize: 14, fontColor: "#3A3A3A", fontWeight: "bold", verticalAlign: "bottom", horizontalAlign: "center"}, toolTip: {fontFamily: v, fontSize: 14, fontStyle: "normal", cornerRadius: 0, borderThickness: 1}, toolbar: {itemBackgroundColor: "white", itemBackgroundColorOnHover: "#2196f3",
    ...
    da = 20;
    B = 14;
    Ga = {colorSet: "colorSet12", backgroundColor: "#2A2A2A", title: {fontFamily: Ga, fontSize: 32, fontColor: Y, fontWeight: "normal", verticalAlign: "top", margin: 5}, subtitles: [{fontFamily: Ga, fontSize: B, fontColor: Y, fontWeight: "normal", verticalAlign: "top", margin: 5}], toolbar: {itemBackgroundColor: "#666666", itemBackgroundColorOnHover: "#FF7372", buttonBorderColor: "#FF7372",
            buttonBorderThickness: 1, fontColor: "#F5F5F5", fontColorOnHover: "#F5F5F5"}, data: [{indexLabelFontFamily: v, indexLabelFontSize: B, indexLabelFontColor: V, indexLabelFontWeight: "normal", indexLabelLineThickness: 1}], axisX: [{titleFontFamily: v, titleFontSize: da, titleFontColor: V, titleFontWeight: "normal", labelFontFamily: v, labelFontSize: B, labelFontColor: V, labelFontWeight: "normal", lineThickness: 1, lineColor: R, tickThickness: 1, tickColor: R, gridThickness: 0, gridColor: R, stripLines: [{labelFontFamily: v, labelFontSize: B, labelFontColor: "#FF7300",
                        labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1}], crosshair: {labelFontFamily: v, labelFontSize: B, labelFontColor: "#000000", labelFontWeight: "normal", labelBackgroundColor: ja, color: ea, thickness: 1, lineDashType: "dash"}, scaleBreaks: {type: "zigzag", spacing: "2%", lineColor: "#777777", lineThickness: 1, lineDashType: "solid", color: "#111111"}}], axisX2: [{titleFontFamily: v, titleFontSize: da, titleFontColor: V, titleFontWeight: "normal", labelFontFamily: v, labelFontSize: B, labelFontColor: V, labelFontWeight: "normal",
                lineThickness: 1, lineColor: R, tickThickness: 1, tickColor: R, gridThickness: 0, gridColor: R, stripLines: [{labelFontFamily: v, labelFontSize: B, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1}], crosshair: {labelFontFamily: v, labelFontSize: B, labelFontColor: "#000000", labelFontWeight: "normal", labelBackgroundColor: ja, color: ea, thickness: 1, lineDashType: "dash"}, scaleBreaks: {type: "zigzag", spacing: "2%", lineColor: "#777777", lineThickness: 1, lineDashType: "solid", color: "#111111"}}],
        axisY: [{titleFontFamily: v, titleFontSize: da, titleFontColor: V, titleFontWeight: "normal", labelFontFamily: v, labelFontSize: B, labelFontColor: V, labelFontWeight: "normal", lineThickness: 1, lineColor: R, tickThickness: 1, tickColor: R, gridThickness: 1, gridColor: R, stripLines: [{labelFontFamily: v, labelFontSize: B, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1}], crosshair: {labelFontFamily: v, labelFontSize: B, labelFontColor: "#000000", labelFontWeight: "normal", labelBackgroundColor: ja,
                    color: ea, thickness: 1, lineDashType: "dash"}, scaleBreaks: {type: "zigzag", spacing: "2%", lineColor: "#777777", lineThickness: 1, lineDashType: "solid", color: "#111111"}}], axisY2: [{titleFontFamily: v, titleFontSize: da, titleFontColor: V, titleFontWeight: "normal", labelFontFamily: v, labelFontSize: B, labelFontColor: V, labelFontWeight: "normal", lineThickness: 1, lineColor: R, tickThickness: 1, tickColor: R, gridThickness: 1, gridColor: R, stripLines: [{labelFontFamily: v, labelFontSize: B, labelFontColor: "#FF7300", labelFontWeight: "normal",
                        labelBackgroundColor: null, color: "#FF7300", thickness: 1}], crosshair: {labelFontFamily: v, labelFontSize: B, labelFontColor: "#000000", labelFontWeight: "normal", labelBackgroundColor: ja, color: ea, thickness: 1, lineDashType: "dash"}, scaleBreaks: {type: "zigzag", spacing: "2%", lineColor: "#777777", lineThickness: 1, lineDashType: "solid", color: "#111111"}}], legend: {fontFamily: v, fontSize: 14, fontColor: Y, fontWeight: "bold", verticalAlign: "bottom", horizontalAlign: "center"}, toolTip: {fontFamily: v, fontSize: 14, fontStyle: "normal", cornerRadius: 0,
            borderThickness: 1, fontColor: V, backgroundColor: "rgba(0, 0, 0, .7)"}};
    R = "#FFFFFF";
    V = Y = "#FAFAFA";
    ea = "#40BAF1";
    ja = "#F5F5F5";
    var da = 20, B = 14, cb = {light1: Wa, light2: bb, dark1: Ga, dark2: {colorSet: "colorSet2", backgroundColor: "#32373A", title: {fontFamily: v, fontSize: 32, fontColor: Y, fontWeight: "normal", verticalAlign: "top", margin: 5}, subtitles: [{fontFamily: v, fontSize: B, fontColor: Y, fontWeight: "normal", verticalAlign: "top", margin: 5}], toolbar: {itemBackgroundColor: "#666666", itemBackgroundColorOnHover: "#FF7372", buttonBorderColor: "#FF7372",
                buttonBorderThickness: 1, fontColor: "#F5F5F5", fontColorOnHover: "#F5F5F5"}, data: [{indexLabelFontFamily: v, indexLabelFontSize: B, indexLabelFontColor: V, indexLabelFontWeight: "normal", indexLabelLineThickness: 1}], axisX: [{titleFontFamily: v, titleFontSize: da, titleFontColor: V, titleFontWeight: "normal", labelFontFamily: v, labelFontSize: B, labelFontColor: V, labelFontWeight: "normal", lineThickness: 1, lineColor: R, tickThickness: 1, tickColor: R, gridThickness: 0, gridColor: R, stripLines: [{labelFontFamily: v, labelFontSize: B, labelFontColor: "#FF7300",
                            labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1}], crosshair: {labelFontFamily: v, labelFontSize: B, labelFontColor: "#000000", labelFontWeight: "normal", labelBackgroundColor: ja, color: ea, thickness: 1, lineDashType: "dash"}, scaleBreaks: {type: "zigzag", spacing: "2%", lineColor: "#777777", lineThickness: 1, lineDashType: "solid", color: "#111111"}}], axisX2: [{titleFontFamily: v, titleFontSize: da, titleFontColor: V, titleFontWeight: "normal", labelFontFamily: v, labelFontSize: B, labelFontColor: V, labelFontWeight: "normal",
                    lineThickness: 1, lineColor: R, tickThickness: 1, tickColor: R, gridThickness: 0, gridColor: R, stripLines: [{labelFontFamily: v, labelFontSize: B, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1}], crosshair: {labelFontFamily: v, labelFontSize: B, labelFontColor: "#000000", labelFontWeight: "normal", labelBackgroundColor: ja, color: ea, thickness: 1, lineDashType: "dash"}, scaleBreaks: {type: "zigzag", spacing: "2%", lineColor: "#777777", lineThickness: 1, lineDashType: "solid", color: "#111111"}}],
            axisY: [{titleFontFamily: v, titleFontSize: da, titleFontColor: V, titleFontWeight: "normal", labelFontFamily: v, labelFontSize: B, labelFontColor: V, labelFontWeight: "normal", lineThickness: 0, lineColor: R, tickThickness: 1, tickColor: R, gridThickness: 1, gridColor: R, stripLines: [{labelFontFamily: v, labelFontSize: B, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1}], crosshair: {labelFontFamily: v, labelFontSize: B, labelFontColor: "#000000", labelFontWeight: "normal", labelBackgroundColor: ja,
                        color: ea, thickness: 1, lineDashType: "dash"}, scaleBreaks: {type: "zigzag", spacing: "2%", lineColor: "#777777", lineThickness: 1, lineDashType: "solid", color: "#111111"}}], axisY2: [{titleFontFamily: v, titleFontSize: da, titleFontColor: V, titleFontWeight: "normal", labelFontFamily: v, labelFontSize: B, labelFontColor: V, labelFontWeight: "normal", lineThickness: 0, lineColor: R, tickThickness: 1, tickColor: R, gridThickness: 1, gridColor: R, stripLines: [{labelFontFamily: v, labelFontSize: B, labelFontColor: "#FF7300", labelFontWeight: "normal",
                            labelBackgroundColor: null, color: "#FF7300", thickness: 1}], crosshair: {labelFontFamily: v, labelFontSize: B, labelFontColor: "#000000", labelFontWeight: "normal", labelBackgroundColor: ja, color: ea, thickness: 1, lineDashType: "dash"}, scaleBreaks: {type: "zigzag", spacing: "2%", lineColor: "#777777", lineThickness: 1, lineDashType: "solid", color: "#111111"}}], legend: {fontFamily: v, fontSize: 14, fontColor: Y, fontWeight: "bold", verticalAlign: "bottom", horizontalAlign: "center"}, toolTip: {fontFamily: v, fontSize: 14, fontStyle: "normal", cornerRadius: 0,
                borderThickness: 1, fontColor: V, backgroundColor: "rgba(0, 0, 0, .7)"}}, theme1: Wa, theme2: bb, theme3: Wa}, I = {numberDuration: 1, yearDuration: 314496E5, monthDuration: 2592E6, weekDuration: 6048E5, dayDuration: 864E5, hourDuration: 36E5, minuteDuration: 6E4, secondDuration: 1E3, millisecondDuration: 1, dayOfWeekFromInt: "Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" ")};
    (function () {
        ta.fSDec = function (h) {
            for (var n = "", r = 0; r < h.length; r++)
                n += String.fromCharCode(Math.ceil(h.length / 57 / 5) ^ h.charCodeAt(r));
            return n
        };
    ...
    var gb = function () {
        ...
        var h = /D{1,4}|M{1,4}|Y{1,4}|h{1,2}|H{1,2}|m{1,2}|s{1,2}|f{1,3}|t{1,2}|T{1,2}|K|z{1,3}|"[^"]*"|'[^']*'/g, n = "Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "), r = "Sun Mon Tue Wed Thu Fri Sat".split(" "),
                w = "January February March April May June July August September October November December".split(" "), v = "Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "), U = /\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g, A = /[^-+\dA-Z]/g;
        return function (B, J, P) {
            var R = P ? P.days : n, O = P ? P.months : w, K = P ? P.shortDays : r, I = P ? P.shortMonths : v;
            P = "";
            var S = !1;
            ...
            P = S ? "getUTC" : "get";
            var X = B[P + "Date"](), N = B[P + "Day"](), $ = B[P + "Month"](), a = B[P + "FullYear"](), d = B[P + "Hours"](), c = B[P + "Minutes"](), b = B[P + "Seconds"](), e = B[P + "Milliseconds"](), f = S ? 0 : B.getTimezoneOffset();
        ...
        if (1 > Math.abs(h)) {
            ...
            r = parseInt(h.toString().split("+")[1]), 20 < r && (r -= 20, h /= Math.pow(10, r), h = h.toString() + Array(r + 1).join("0"));
        return String(h)
    }, fa = function (h, n, r) {
        if (null === h)
            return"";
        ...
        var w = 0 > h ? !0 : !1;
        w && (h *= -1);
        var v = r ? r.decimalSeparator : ".", U = r ? r.digitGroupSeparator : ",", A = "";
        n = String(n);
        var A = 1, B = r = "", J = -1, P = [], R = [], O = 0, K = 0, I = 0, S = !1, X = 0, B = n.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);
        n = null;
        for (var N = 0; B && N < B.length; N++)
            ...
            B[N], "." === n && 0 > J)
                ...
                if ("%" === n)
                    ...
                    "E" !== n[0] && "e" !== n[0] || "0" !== n[n.length - 1] || (S = !0);
        ...
        for (S = B = N = K = J = 0; 0 < P.length; )
            if (n = P.pop(), "#" === n || "0" === n)
                if (J++, J === O) {
                    var $ = A, A = [];
                    if ("0" === n)
                        for (n = O - K - ($?$.length:0); 0 < n; )
                            $.unshift("0"), n--;
                    for (; 0 < $.length; )
                        r = $.pop() + r, S++, 0 === S % B && (N === I && 0 < $.length) && (r = U + r)
                } else
                    0 < A.length ? (r = A.pop() + r, K++, S++) : "0" === n && (r = "0" + r, K++, S++), 0 === S % B && (N === I && 0 < A.length) && (r = U + r);
            else
                "E" !== n[0] && "e" !== n[0] || "0" !== n[n.length - 1] || !/[eE][+-]*[0]+/.test(n) ? "," === n ? (N++, B = S, S = 0, 0 < A.length && (r = U + r)) : r = 1 < n.length && ('"' ===
                n[0] && '"' === n[n.length - 1] || "'" === n[0] && "'" === n[n.length - 1]) ? n.slice(1, n.length - 1) + r : n + r : (n = 0 > X ? n.replace("+", "").replace("-", "") : n.replace("-", ""), r += n.replace(/[0]+/, function (a) {
                    return Z(X, a.length)
                }));
        U = "";
        for (P = !1; 0 < R.length; )
            n = R.shift(), "#" === n || "0" === n ? 0 < h.length && 0 !== Number(h.join("")) ? (U += h.shift(), P = !0) : "0" === n && (U += "0", P = !0) : 1 < n.length && ('"' === n[0] && '"' === n[n.length - 1] || "'" === n[0] && "'" === n[n.length - 1]) ? U += n.slice(1, n.length - 1) : "E" !== n[0] && "e" !== n[0] || "0" !== n[n.length - 1] || !/[eE][+-]*[0]+/.test(n) ?
                    U += n : (n = 0 > X ? n.replace("+", "").replace("-", "") : n.replace("-", ""), U += n.replace(/[0]+/, function (a) {
                        return Z(X, a.length)
                    }));
        r += (P ? v : "") + U;
        return w ? "-" + r : r
        ...
        return{x: n, y: r}
    }, ab = !0, Sa = window.devicePixelRatio || 1, Oa = 1, ia = ab ? Sa / Oa : 1, ba = function (h, n, r, w, v, B, A, J, O, P, R, S, K) {
    ...
    X.prototype.setOptions = function (h, n) {
        if (oa[this._defaultsKey]) {
            var r = oa[this._defaultsKey], w;
            for (w in r)
                "publicProperties" !== w && r.hasOwnProperty(w) && (this[w] = h && w in h ? h[w] : n && w in n ? n[w] : r[w])
        } else
    ...
    X.prototype.addTo = function (h, n, r, w) {
        ...
        v.hasOwnProperty(h) || v.publicProperties && v.publicProperties.hasOwnProperty(h) && "readWrite" === v.publicProperties[h] ? (this.options._isPlaceholder && this.createUserOptions(), "undefined" === typeof this.options[h] && (this.options[h] =
    ...
    X.prototype.createUserOptions = function (h) {
        if ("undefined" !== typeof h || this.options._isPlaceholder)
            if (this.parent.options._isPlaceholder &&
                ...
                var n = this.parent.options[this.optionsName], r = n.length;
                this.options._isPlaceholder || (Ea(n), r = n.indexOf(this.options));
                this.options = "undefined" === typeof h ? {} : h;
                n[r] = this.options
            } else
                this.options = "undefined" === typeof h ? {} : h, h = this.parent.options, this.optionsName ? n = this.optionsName : (n = this._defaultsKey) && 0 !== n.length ? (r = n.charAt(0).toLowerCase(), 1 < n.length && (r = r.concat(n.slice(1))),
    ...
    X.prototype.updateOption = function (h) {
        ...
        var n = oa[this._defaultsKey], w = {}, v = this[h], B = this._themeOptionsKey,
                U = this._index;
    ...
    X.prototype.dispatchEvent = function (h, n, r) {
        if (h && this._eventListeners[h]) {
            ...
            for (var w = this._eventListeners[h], v = 0; v < w.length; v++)
                w[v].eventHandler.call(w[v].context,
                        n)
        }
    ...
    ka.prototype.render = function (h) {
        if (0 !== this.fontSize) {
            ...
            var w = 0, v = this.topPadding, B = null;
            ...
            for (r = 0; r < this._wrappedText.lines.length; r++) {
                ...
                if ("right" === this.horizontalAlign || "right" === this.textAlign)
                    ...
                    w = (this.width - (this.leftPadding + this.rightPadding)) / 2 - B.width / 2 + this.leftPadding;
    ...
    ka.prototype._getLineWithWidth = function (h, n, r) {
        ...
        if (!h)
            return{text: "", width: 0};
        var w = r = 0, v = h.length - 1, B = Infinity;
        for (this.ctx.font = this._getFontString(); w <= v; ) {
            var B = Math.floor((w + v) / 2), A = h.substr(0, B + 1);
    ...
    ka.prototype._wrapText = function () {
        var h = new String(Ha(String(this.text))), n = [], r = this.ctx.font, w = 0, v = 0;
        this.ctx.font = this._getFontString();
        if (0 === this.frontSize)
            v = w = 0;
        else
            for (; 0 < h.length; ) {
                var B = this.maxHeight - (this.topPadding +
                        this.bottomPadding), A = this._getLineWithWidth(h, this.maxWidth - (this.leftPadding + this.rightPadding), !1);
                A.height = this._lineHeight;
                n.push(A);
                var J = v, v = Math.max(v, A.width), w = w + A.height, h = Ha(h.slice(A.text.length, h.length));
    ...
    ya.prototype.setLayout = function () {
        if (this.text) {
            var h = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, n = h.layoutManager.getFreeSpace(), w = n.x1, v = n.y1, B = 0, J = 0, A = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 22 : 0, I, K;
            ...
            J = new ka(this.ctx, {fontSize: this.fontSize, fontFamily: this.fontFamily, fontColor: this.fontColor, fontStyle: this.fontStyle, fontWeight: this.fontWeight, horizontalAlign: this.horizontalAlign, textAlign: this.horizontalAlign, verticalAlign: this.verticalAlign, borderColor: this.borderColor,
    ...
    var Qa = {addTheme: function (h, n) {
            ...
            La[h] = n
        }, formatNumber: function (h, n, r) {
            r = r || "en";
            if (La[r])
                return fa(h, n || "#,##0.##", new Ka(r));
            throw"Unknown Culture Name";
        }, formatDate: function (h, r, w) {
            w = w || "en";
            if (La[w])
                return Aa(h, r || "DD MMM YYYY", new Ka(w));
            throw"Unknown Culture Name";
        }};
    ...
    v = Qa.Chart = function () {
            ...
            (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) ?
                    (this.container.innerHTML = "", d = a = 0, a = this.options.width ? this.width : 0 < this.container.clientWidth ? this.container.clientWidth : this.width, d = this.options.height ? this.height : 0 < this.container.clientHeight ? this.container.clientHeight : this.height, this.width = a, this.height = d, this.x1 = this.y1 = 0, this.x2 = this.width, this.y2 = this.height, this.selectedColorSet = "undefined" !== typeof za[this.colorSet] ? za[this.colorSet] : za.colorSet1, this._canvasJSContainer = document.createElement("div"), this._canvasJSContainer.setAttribute("class",
                            ...
                            "none", this.canvas.style.userSelect = "none", this.canvas.getContext && (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Da(this.ctx), this._preRenderCtx = this._preRenderCanvas.getContext("2d"), this._preRenderCtx.textBaseline = "top", Da(this._preRenderCtx), w ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = ra(a, d), this.plotArea.canvas.style.position = "absolute", this.plotArea.canvas.setAttribute("class", "plotAreaCanvas"), this._canvasJSContainer.appendChild(this.plotArea.canvas),
                                    ...
                                    this.overlaidCanvasCtx.textBaseline = "top", Da(this.overlaidCanvasCtx)), this._eventManager = new ea(this), this.windowResizeHandler = K(window, "resize", function () {
                                b._updateSize() && b.render()
                            }, this.allDOMEventHandlers), this._toolBar = document.createElement("div"), this._toolBar.setAttribute("class", "canvasjs-chart-toolbar"), S(this._toolBar, {position: "absolute", right: "1px", top: "1px"}), this._canvasJSContainer.appendChild(this._toolBar), this.bounds = {x1: 0, y1: 0, x2: this.width, y2: this.height}, K(this.overlaidCanvas,
                                    "click", function (a) {
        ...
        n.prototype._updateOptions = function () {
            ...
            if (this.options.zoomEnabled || this.panEnabled) {
                if (this._zoomButton)
                    S(this._zoomButton, {borderRight: this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor, backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor}), pa(this, this._zoomButton, "zoom");
                else {
                    var d = !1;
                    ...
                    K(this._zoomButton, "mousemove", function () {
                        d ? d = !1 : (S(a._zoomButton, {backgroundColor: a.toolbar.itemBackgroundColorOnHover, color: a.toolbar.fontColorOnHover, transition: "0.4s",
                            WebkitTransition: "0.4s"}), 0 >= navigator.userAgent.search("MSIE") && S(a._zoomButton.childNodes[0], {WebkitFilter: "invert(100%)", filter: "invert(100%)"}))
                    }, this.allDOMEventHandlers);
                    K(this._zoomButton, "mouseout", function () {
                        d || (S(a._zoomButton, {backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor, transition: "0.4s", WebkitTransition: "0.4s"}), 0 >= navigator.userAgent.search("MSIE") && S(a._zoomButton.childNodes[0], {WebkitFilter: "invert(0%)", filter: "invert(0%)"}))
                    }, this.allDOMEventHandlers)
                }
                this._resetButton ?
                    ...
                    if (a.sessionVariables.axisX)
                        for (var b = 0; b < a.sessionVariables.axisX.length; b++)
                            a.sessionVariables.axisX[b].newViewportMinimum =
                    ...
                    if (a.sessionVariables.axisY2)
                        for (b = 0; b < a.sessionVariables.axisY2.length; b++)
                            a.sessionVariables.axisY2[b].newViewportMinimum =
                    ...
                    d || (S(a._resetButton, {backgroundColor: a.toolbar.itemBackgroundColorOnHover, color: a.toolbar.fontColorOnHover,
                        transition: "0.4s", WebkitTransition: "0.4s"}), 0 >= navigator.userAgent.search("MSIE") && S(a._resetButton.childNodes[0], {WebkitFilter: "invert(100%)", filter: "invert(100%)"}))
                }, this.allDOMEventHandlers), K(this._resetButton, "mouseout", function () {
                    d || (S(a._resetButton, {backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor, transition: "0.4s", WebkitTransition: "0.4s"}), 0 >= navigator.userAgent.search("MSIE") && S(a._resetButton.childNodes[0], {WebkitFilter: "invert(0%)", filter: "invert(0%)"}))
                }, this.allDOMEventHandlers),
        ...
        n.prototype.setLayout = function () {
                        ...
                        if (this.options.axisY && 0 < this.options.axisY.length) {
                            if (!this.axisY.length)
                                for (var c = 0; c < this.options.axisY.length; c++)
                                    "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY[c] = new A(this, "axisY", this.options.axisY[c], c, "axisY", "left")) : "xySwapped" ===
                            ...
                            this.axisY.length || ("normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY[0] = new A(this, "axisY", this.options.axisY,
                        ...
                        if (this.options.axisY2 && 0 < this.options.axisY2.length) {
                            if (!this.axisY2.length)
                                for (c = 0; c < this.options.axisY2.length; c++)
                                    "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY2[c] = new A(this, "axisY2", this.options.axisY2[c], c,
                        ...
                        if (this.options.axisX && 0 < this.options.axisX.length) {
                            if (!this.axisX.length)
                                for (c = 0; c < this.options.axisX.length; c++)
                                    "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX[c] =
                        ...
                        if (this.options.axisX2 && 0 < this.options.axisX2.length) {
                            if (!this.axisX2.length)
                                for (c = 0; c < this.options.axisX2.length; c++)
                                    "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX2[c] =
            ...
            for (d = 0; d < this.data.length; d++)
                (this.data[d].showInLegend || "pie" === this.data[d].type || "doughnut" === this.data[d].type || "funnel" === this.data[d].type ||
        ...
        n.prototype.renderElements = function () {
            if (this.height) {
                ...
                var m = this;
                if (0 < c.length)
                    m.disableToolTip = !0, m._animator.animate(200, m.animationDuration, function (a) {
                        m.ctx.clearRect(0, 0, m.width, m.height);
                        m.ctx.drawImage(b, 0, 0, Math.floor(m.width * ia), Math.floor(m.height * ia), 0, 0, m.width, m.height);
                        for (var e = 0; e < c.length; e++)
                            D = c[e], 1 > a && "undefined" !== typeof D.startTimePercent ? a >= D.startTimePercent && D.animationCallback(D.easingFunction(a - D.startTimePercent, 0, 1, 1 - D.startTimePercent), D) :
            ...
            for (var a = "", d = 0; d < this.data.length; d++)
                if (a = this.data[d], a.dataPoints && (0 !== a.dataPoints.length && a.visible) && 0 <= n._supportedChartTypes.indexOf(a.type)) {
                    ...
                    b || (c = {type: a.type, totalDataSeries: 0,
                        plotUnits: []}, this.plotInfo.plotTypes.push(c));
                    ...
                    f || (e = {type: a.type, previousDataSeriesCount: 0, index: c.plotUnits.length, plotType: c, axisXType: a.axisXType, axisYType: a.axisYType, axisYIndex: a.axisYIndex, axisXIndex: a.axisXIndex, axisY: "primary" === a.axisYType ? this.axisY[0 <= a.axisYIndex &&
                    ...
                    for (D = 0; D < t.dataPoints.length; D++) {
                        ...
                        if (0 <
                            ...
                            if (a.axisX.logarithmic) {
                                ...
                                s = b - t.dataPoints[D - 1].x, 0 > s && (s *= -1), c.minDiff > s && 0 !== s && (c.minDiff = s);
        ...
        n.prototype._processStackedPlotUnit = function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = [], t = [],
                    ...
                    var p = this.data[a.dataSeriesIndexes[m]], q = 0, g = !1, s = !1, h;
                    if ("normal" === p.axisPlacement || "xySwapped" === p.axisPlacement)
                        var ca = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : a.axisX.options && a.axisX.options.viewportMinimum ? a.axisX.options.viewportMinimum : a.axisX.options && a.axisX.options.minimum ? a.axisX.options.minimum : -Infinity, u = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum :
                    ...
                    for (q = 0; q < p.dataPoints.length; q++) {
                        ...
                        if (0 < q) {
                            if (a.axisX.logarithmic) {
                                ...
                                n = b - p.dataPoints[q - 1].x, 0 > n && (n *= -1), c.minDiff > n && 0 !== n && (c.minDiff = n);
        ...
        n.prototype._processMultiYPlotUnit = function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo,
                    ...
                    var k = this.data[a.dataSeriesIndexes[D]], m = 0, p = !1, q = !1, g, s, h;
        ...
        n.prototype._processSpecificPlotUnit = function (a) {
            if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                    var t = this.data[a.dataSeriesIndexes[l]], D = 0, k = !1, m = !1, p = b = 0;
                    if ("normal" === t.axisPlacement || "xySwapped" === t.axisPlacement)
        ...
        n.prototype.calculateAutoBreaks = function () {
            function a(a, b, c, e) {
                if (e)
                    return c = Math.pow(Math.min(c * a / b, b / a),
                                    ...
                                    if (b && (q = (l + 1 - k) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, f = h.dataPoints[t].x.getTime ? h.dataPoints[t].x.getTime() : h.dataPoints[t].x, q = Math.floor((f - k) / q), f < g[q].min && (g[q].min = f), f > g[q].max && (g[q].max = f)), c) {
                                        ...
                                        if ((f = "waterfall" === a.type ? h.dataPointEOs[t].cumulativeSum : h.dataPoints[t].y) && f.length)
                                            for (var w = 0; w < f.length; w++)
                                                q = Math.floor((f[w] - m) / n), f[w] < d[q].min && (d[q].min = f[w]), f[w] > d[q].max && (d[q].max = f[w]);
                                        else
                                            r(f) || (q = Math.floor((f - m) / n), f < d[q].min && (d[q].min = f), f > d[q].max && (d[q].max = f))
                                    }
                        }
                }
            }
                    ...
                    for (var b = a.axisX.dataInfo, c =
                        ...
                        if (!(4 > m.dataPoints.length))
                            for (k = 0; k < m.dataPoints.length; k++)
                                f = (d + 1 - c) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, b = m.dataPoints[k].x.getTime ? m.dataPoints[k].x.getTime() : m.dataPoints[k].x, f = Math.floor((b - c) / f), b < g[f].min && (g[f].min = b), b > g[f].max && (g[f].max = b)
                    }
            }
            ...
            if (f) {
                for (l = 0; l < this.plotInfo.plotTypes.length; l++)
                    for (f = this.plotInfo.plotTypes[l], t = 0; t < f.plotUnits.length; t++)
                        b = f.plotUnits[t], "line" === b.type || "stepLine" === b.type || "spline" === b.type || "column" === b.type || "area" === b.type || "stepArea" === b.type ||
                ...
                for (l = 0; l < this._axes.length; l++)
                    if (this._axes[l].dataInfo._dataRanges) {
                        ...
                        for (t =
                                0; t < Math.min(f.length, this._axes[l].scaleBreaks.maxNumberOfAutoBreaks); t++)
        ...
        n.prototype.renderCrosshairs = function (a) {
            ...
            for (d = 0; d < this.axisX2.length; d++)
                this.axisX2[d] != a && (this.axisX2[d].crosshair && this.axisX2[d].crosshair.enabled && !this.axisX2[d].crosshair._hidden) &&
        ...
        n.prototype.getDataPointAtXY =
                function (a, d, c) {
                    ...
                    for (c = 0; c < b.length; c++)
                        d && "line" !== b[c].dataSeries.type && "stepLine" !== b[c].dataSeries.type &&
        ...
        n.prototype._touchEventHandler = function (a) {
            if (a.changedTouches && this.interactivityEnabled) {
                ...
                switch (a.type) {
                    ...
                    case "touchend":
                    case "MSPointerUp":
                        var f = this._lastTouchData && this._lastTouchData.time ? new Date - this._lastTouchData.time : 0, d = "touchstart" === this._lastTouchEventType || "MSPointerDown" === this._lastTouchEventType || 300 > f ? ["mouseup", "click"] : ["mouseup"];
                        break;
                        default:
                        return
                    }
                if (!(c && 1 < c.length)) {
                    ...
                    if (this._lastTouchData.scroll && this.zoomEnabled)
                        ...
                        for (c = 0; c < d.length; c++)
                            if (e = d[c], l = document.createEvent("MouseEvent"), l.initMouseEvent(e, !0, !0, window, 1, b.screenX, b.screenY, b.clientX, b.clientY, !1, !1, !1, !1, 0, null), b.target.dispatchEvent(l), !r(this._lastTouchData.scroll) && !this._lastTouchData.scroll || !this._lastTouchData.scroll && 250 < f || "click" === e)
            ...
            for (var e = 0; e < b.length; e++)
                if (r(c[b[e]]) && (c[b[e]] = []), "axisY" === b[e])
                    ...
                    for (f = 0; f < this.axisX2.length; f++)
                        c[b[e]].push({viewportMinimum: this[b[e]][f].sessionVariables.newViewportMinimum,
            ...
            if (this.interactivityEnabled)
                if (this._ignoreNextEvent)
                    ...
                    if (d.x < c.x1 || d.x > c.x2 || d.y < c.y1 || d.y > c.y2) {
                        ...
                        for (f = 0; f < this.axisX.length; f++)
                            this.axisX[f].crosshair && this.axisX[f].crosshair.enabled &&
                        ...
                        for (f = 0; f < this.axisY.length; f++)
                            this.axisY[f].crosshair && this.axisY[f].crosshair.enabled && (this.axisY[f].crosshair.hide(),
        ...
        n.prototype._plotAreaMouseUp = function (a, d) {
            ...
            if ("none" !== this.plotInfo.axisPlacement) {
                ...
                if (this.axisX2 && 0 < this.axisX2.length)
                    for (l = 0; l < this.axisX2.length; l++)
                        this.axisX2[l].crosshair && this.axisX2[l].crosshair.enabled &&
            ...
            if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
                ...
                if (2 < Math.abs(c) && 8 > Math.abs(c) && (this.panEnabled || this.zoomEnabled)) {
                    ...
                    for (var t = 0; t < this.axisX.length; t++)
                        this.axisX[t].crosshair && this.axisX[t].crosshair.enabled && (this.axisX[t].crosshair.hide(), this.axisX[t].crosshair.dispatchEvent("hidden",
                                {chart: this, axis: this.axisX[t].options}, this.axisX[t].crosshair));
                    ...
                    for (t = 0; t < this.axisY.length; t++)
                        this.axisY[t].crosshair && this.axisY[t].crosshair.enabled && (this.axisY[t].crosshair.hide(), this.axisY[t].crosshair.dispatchEvent("hidden", {chart: this, axis: this.axisY[t].options},
                ...
                if ((!e || 2 < Math.abs(c) || !f || 2 < Math.abs(b)) && (this.panEnabled || this.zoomEnabled))
                    if (this.panEnabled)
                        e = {x1: e ? this.plotArea.x1 + c : this.plotArea.x1, y1: f ? this.plotArea.y1 +
                                    b : this.plotArea.y1, x2: e ? this.plotArea.x2 + c : this.plotArea.x2, y2: f ? this.plotArea.y2 + b : this.plotArea.y2}, clearTimeout(l._panTimerId), l._panTimerId = setTimeout(function (b, c, e, f) {
                            return function () {
                        ...
                        var b = e ? this.dragStartPoint.x : this.plotArea.x1,
                                t = f ? this.dragStartPoint.y : this.plotArea.y1, D = e ? a - this.dragStartPoint.x : this.plotArea.x2 - this.plotArea.x1, k = f ? d - this.dragStartPoint.y : this.plotArea.y2 - this.plotArea.y1;
                ...
                if (this.axisY && 0 < this.axisY.length)
                    for (e = 0; e < this.axisY.length; e++)
                        this.axisY[e].crosshair && this.axisY[e].crosshair.enabled && this.axisY[e].renderCrosshair(a,
                                d);
                if (this.axisY2 && 0 < this.axisY2.length)
        ...
        n.prototype.validateRegion = function (a, d, c, b, e) {
            e = e || !1;
            for (var f = 0 <= this.zoomType.indexOf("x"), l = 0 <= this.zoomType.indexOf("y"), t = !1, D = [], k = [], m = [], p = 0; p < this._axes.length; p++)
                ("axisX" === this._axes[p].type &&
                        f || "axisY" === this._axes[p].type && l) && k.push(this._axes[p]);
            for (l = 0; l < k.length; l++) {
                var p = k[l], f = !1, q = p.convertPixelToValue({x: a, y: d}), g = p.convertPixelToValue({x: c, y: b});
                if (q > g)
                    var s = g, g = q, q = s;
                if (p.scaleBreaks)
                    for (s = 0; !f && s < p.scaleBreaks._appliedBreaks.length; s++)
                        f = p.scaleBreaks._appliedBreaks[s].startValue <= q && p.scaleBreaks._appliedBreaks[s].endValue >= g;
                if (isFinite(p.dataInfo.minDiff))
                    if (s = p.getApparentDifference(q, g, null, !0), !(f || !(this.panEnabled && p.scaleBreaks && p.scaleBreaks._appliedBreaks.length) &&
                            (p.logarithmic && s < Math.pow(p.dataInfo.minDiff, 3) || !p.logarithmic && s < 3 * Math.abs(p.dataInfo.minDiff)) || q < p.minimum || g > p.maximum))
                        D.push(p), m.push({val1: q, val2: g}), t = !0;
                    else if (!e) {
                        t = !1;
                        break
                    }
        ...
        n.prototype.renderIndexLabels = function (a) {
            var d = a || this.plotArea.ctx, c = this.plotArea,
                    b = 0, e = 0, f = 0, l = f = e = 0, t = 0, D = b = 0, k = 0;
            for (a = 0; a < this._indexLabels.length; a++) {
                var m = this._indexLabels[a], p = m.chartType.toLowerCase(), q, g, l = la("indexLabelFontColor", m.dataPoint, m.dataSeries), s = la("indexLabelFontSize", m.dataPoint, m.dataSeries), t = la("indexLabelFontFamily", m.dataPoint, m.dataSeries), D = la("indexLabelFontStyle", m.dataPoint, m.dataSeries), k = la("indexLabelFontWeight", m.dataPoint, m.dataSeries), h = la("indexLabelBackgroundColor", m.dataPoint, m.dataSeries);
                q = la("indexLabelMaxWidth", m.dataPoint, m.dataSeries);
                g = la("indexLabelWrap", m.dataPoint, m.dataSeries);
                var n = la("indexLabelLineDashType", m.dataPoint, m.dataSeries), u = la("indexLabelLineColor", m.dataPoint, m.dataSeries), y = r(m.dataPoint.indexLabelLineThickness) ? r(m.dataSeries.options.indexLabelLineThickness) ? 0 : m.dataSeries.options.indexLabelLineThickness : m.dataPoint.indexLabelLineThickness, b = 0 < y ? Math.min(10, ("normal" === this.plotInfo.axisPlacement ? this.plotArea.height : this.plotArea.width) << 0) : 0, x = {percent: null, total: null}, z = null;
                if (0 <= m.dataSeries.type.indexOf("stacked") ||
                        "pie" === m.dataSeries.type || "doughnut" === m.dataSeries.type)
                ...
                if (null !== G && "" !== G) {
                    var x = la("indexLabelPlacement", m.dataPoint, m.dataSeries), z = la("indexLabelOrientation", m.dataPoint, m.dataSeries), C = la("indexLabelTextAlign", m.dataPoint, m.dataSeries), v = m.direction, e = m.dataSeries.axisX, f = m.dataSeries.axisY, A = !1, h = new ka(d, {x: 0, y: 0, maxWidth: q ? q : 0.5 * this.width, maxHeight: g ? 5 * s : 1.5 * s, angle: "horizontal" ===
                                z ? 0 : -90, text: G, padding: 0, backgroundColor: h, textAlign: C, fontSize: s, fontFamily: t, fontWeight: k, fontColor: l, fontStyle: D, textBaseline: "middle"});
                    h.measureText();
            ...
            for (a = 0; a < this._indexLabels.length; a++)
                m = this._indexLabels[a], h = la("indexLabelBackgroundColor", m.dataPoint, m.dataSeries), m.dataSeries.indexLabelBackgroundColor = r(h) ? w ? "transparent" : null : h;
            return d
        };
        n.prototype.renderLine = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f = [], l, t = 0; t < a.dataSeriesIndexes.length; t++) {
                    ...
                    var s = k.id;
                    this._eventManager.objectMap[s] = {objectType: "dataSeries",
                        dataSeriesIndex: D};
                    s = O(s);
                    b.strokeStyle = s;
                    b.lineWidth = 0 < k.lineThickness ? Math.max(k.lineThickness, 4) : 0;
                    var s = k._colorSet, h = s = k.lineColor = k.options.lineColor ? k.options.lineColor : s[0];
                    c.strokeStyle = s;
                    var n = !0, u = 0, r, x;
                    c.beginPath();
                    if (0 < m.length) {
                        for (var z = !1, u = 0; u < m.length; u++)
                            if (r = m[u].x.getTime ? m[u].x.getTime() : m[u].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !z)))
                                if ("number" !== typeof m[u].y)
                                    0 < u && !(k.connectNullData || z || n) && (c.stroke(), w && b.stroke()), z =
                                            !0;
                                else {
                                ...
                                for (var z = !1, u = 0; u < m.length; u++)
                                    if (r = m[u].getTime ? m[u].x.getTime() : m[u].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !z)))
                                        if ("number" !== typeof m[u].y)
                                            ...
                                            (m[u].indexLabel || k.indexLabel || m[u].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({chartType: "stepLine", dataPoint: m[u], dataSeries: k, point: {x: r, y: x}, direction: 0 > m[u].y === a.axisY.reversed ?
                                                        1 : -1, color: s})
                                        }
                                c.stroke();
                                w && b.stroke()
        ...
        n.prototype.renderSpline = function (a) {
                ...
                if (0 < a.length) {
                    ...
                    for (var c = 0; c < a.length - 3; c += 3)
                        if (b.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y),
                                w && e.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y), 0 < c && 0 === c % 3E3 || a[c + 3].newStrokeStyle || a[c + 3].newLineDashArray)
                            b.stroke(), b.beginPath(), b.moveTo(a[c + 3].x, a[c + 3].y), a[c + 3].newStrokeStyle && (b.strokeStyle = a[c + 3].newStrokeStyle), a[c + 3].newLineDashArray && b.setLineDash(a[c + 3].newLineDashArray), w && (e.stroke(), e.beginPath(), e.moveTo(a[c + 3].x, a[c + 3].y));
                    b.stroke();
                    w && e.stroke()
                }
            }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                        ...
                        for (n = !1, r = 0; r < m.length; r++)
                            if (u = m[r].getTime ? m[r].x.getTime() : m[r].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !n)))
                                if ("number" !== typeof m[r].y)
                                    0 < r && !n && (k.connectNullData ? b.setLineDash && (0 < x.length && (k.options.nullDataLineDashType || !m[r - 1].lineDashType)) && (x[x.length -
                                    ...
                                    (m[r].indexLabel || k.indexLabel || m[r].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({chartType: "spline", dataPoint: m[r], dataSeries: k, point: {x: u, y: n}, direction: 0 > m[r].y === a.axisY.reversed ?
                                                1 : -1, color: s});
                                    n = !1
                                }
                    d(x)
                ...
                b.beginPath();
                return{source: c,
                    dest: this.plotArea.ctx, animationCallback: N.xClipAnimation, easingFunction: N.easing.linear, animationBase: 0}
            }
        };
        n.prototype.renderColumn = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = w ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = 0, l, t, D, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, m = this.options.dataPointMaxWidth ?
                        this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.width, 0.9 * (this.plotArea.width / a.plotType.totalDataSeries)) << 0, p = a.axisX.dataInfo.minDiff;
                    ...
                    if (0 < s.length)
                        for (var h = 5 < p && g.bevelEnabled ? !0 : !1, f = 0; f < s.length; f++)
                            if (s[f].getTime ? D = s[f].x.getTime() : D = s[f].x, !(D < a.axisX.dataInfo.viewPortMin || D > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[f].y) {
                                ...
                                var r = a.axisX.reversed ? l - p << 0 : l + p << 0, u;
                                0 <= s[f].y ? u = k : (u = t, t = k);
                                t > u && (b = t, t = u, u = b);
                                ...
                                b = O(b);
                                w && ba(this._eventManager.ghostCtx, a.axisX.reversed ? r : l, t, a.axisX.reversed ? l : r, u, b, 0, null, !1, !1,
                                        !1, !1);
                ...
                function (a) {
                    ...
                    if (!(0 >= a.dataSeriesIndexes.length)) {
                        ...
                        for (g = 0; g < a.dataSeriesIndexes.length; g++) {
                            var h = a.dataSeriesIndexes[g], r = this.data[h], u = r.dataPoints;
                            if (0 < u.length) {
                                ...
                                for (k = 0; k < u.length; k++)
                                    if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) &&
                                        ...
                                        if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y)
                                            ...
                                            D[b] = u[k].y + (D[b] ? D[b] : 0), z = a.axisY.convertValueToPixel(D[b]), p = "undefined" !== typeof l[b] ?
                                            l[b] : q, l[b] = z;
                                            ...
                                            G = l[b] ? l[b] : 0, z = p + G, p = q + G, l[b] = G + (z - p);
                                        ...
                                        b = r.dataPointIds[k];
                                        this._eventManager.objectMap[b] = {id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k,
                                            x1: m, y1: p, x2: x, y2: z};
                                        b = O(b);
                        ...
                        c.restore();
                        return{source: d, dest: this.plotArea.ctx, animationCallback: N.yScaleAnimation, easingFunction: N.easing.easeOutQuart, animationBase: q < a.axisY.bounds.y1 ? a.axisY.bounds.y1 :
        ...
        n.prototype.renderStackedColumn100 = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = [], l = [], t = [], D = [], k = 0, m, p, q = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), k = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, g = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ?
                        this.dataPointWidth : 0.15 * this.width << 0, s = a.axisX.dataInfo.minDiff;
                isFinite(s) || (s = 0.3 * Math.abs(a.axisX.range));
                s = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.width * (a.axisX.logarithmic ? Math.log(s) / Math.log(a.axisX.range) : Math.abs(s) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0;
                this.dataPointMaxWidth && k > g && (k = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, g));
                            ...
                            if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin ||
                                ...
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) {
                                    ...
                                    f[b] = p
                                        ...
                                        0 >= u[k].y)
                                    D[b] = p + ("undefined" !== typeof D[b] ? D[b] : 0), z = a.axisY.convertValueToPixel(D[b]), p = l[b] ? l[b] : q, l[b] = z;
                                    ...
                                    G = "undefined" !== typeof l[b] ? l[b] : 0, z = p + G, p = q + G, a.dataSeriesIndexes.length - 1 === g && 1 >= Math.abs(e.y2 - z) && (z = e.y2), l[b] = G + (z - p);
                                b = u[k].color ? u[k].color : r._colorSet[k % r._colorSet.length];
                                ...
                                b = O(b);
                                w && ba(this._eventManager.ghostCtx, m, p, x, z, b, 0, null, !1, !1, !1, !1);
                                (u[k].indexLabel || r.indexLabel || u[k].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({chartType: "stackedColumn100", dataPoint: u[k], dataSeries: r,
                                    point: {x: m + (x - m) / 2, y: 0 <= u[k].y ? p : z}, direction: 0 > u[k].y === a.axisY.reversed ? 1 : -1, bounds: {x1: m, y1: Math.min(p, z), x2: x, y2: Math.max(p, z)}, color: b})
                            }
                }
        ...
        n.prototype.renderBar = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = w ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = 0, l, t, D, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
                ...
                for (m = 0; m < a.dataSeriesIndexes.length; m++) {
                    var q = a.dataSeriesIndexes[m], g = this.data[q], s = g.dataPoints;
                    if (0 < s.length) {
                        ...
                        for (f = 0; f < s.length; f++)
                            if (s[f].getTime ? D = s[f].x.getTime() : D = s[f].x, !(D < a.axisX.dataInfo.viewPortMin || D > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[f].y) {
                                ...
                                var r = a.axisX.reversed ? t - p << 0 : t + p << 0, u;
                                0 <= s[f].y ? u = k : (u = l, l = k);
                                b = s[f].color ? s[f].color : g._colorSet[f % g._colorSet.length];
                ...
                c.restore();
                return{source: d, dest: this.plotArea.ctx, animationCallback: N.xScaleAnimation, easingFunction: N.easing.easeOutQuart, animationBase: k < a.axisY.bounds.x1 ? a.axisY.bounds.x1 : k > a.axisY.bounds.x2 ? a.axisY.bounds.x2 :
                    k}
            }
        };
                        ...
                        for (k = 0; k < u.length; k++)
                            if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x,
                                ...
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y)
                                    ...
                                    G = l[b] ? l[b] : 0, z = m - G, m = q - G, l[b] = G + (m - z);
                                b = u[k].color ? u[k].color : r._colorSet[k % r._colorSet.length];
                ...
                function (a) {
                    ...
                    if (!(0 >= a.dataSeriesIndexes.length)) {
                                ...
                                for (k = 0; k < u.length; k++)
                                    if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin ||
                                        ...
                                        if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) {
                                            ...
                                            G = l[b] ? l[b] : 0, x = m - G, m = q - G, a.dataSeriesIndexes.length - 1 === g && 1 >= Math.abs(e.x1 - x) && (x = e.x1), l[b] = G + (m - x);
                                        b = u[k].color ? u[k].color : r._colorSet[k % r._colorSet.length];
                        ...
                        w && (d.drawImage(this._preRenderCanvas,
                                0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.restore());
                        c.restore();
                        return{source: d, dest: this.plotArea.ctx, animationCallback: N.xScaleAnimation, easingFunction: N.easing.easeOutQuart,
        ...
        n.prototype.renderArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var l = this._eventManager.ghostCtx, t = a.axisY.lineCoordinates, D = [], k = this.plotArea, m;
                f.save();
                w && l.save();
                f.beginPath();
                ...
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    var q = a.dataSeriesIndexes[p], g = this.data[q], s = g.dataPoints, D = g.id;
                    this._eventManager.objectMap[D] =
                            {objectType: "dataSeries", dataSeriesIndex: q};
                    D = O(D);
                    l.fillStyle = D;
                    D = [];
                    d = !0;
                    var h = 0, r, u, n, x = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), z, G = null;
                    if (0 < s.length) {
                        var C = g._colorSet[h % g._colorSet.length], v = g.lineColor = g.options.lineColor || C, A = v;
                        f.fillStyle = C;
                        f.strokeStyle = v;
                        ...
                        for (var ga = !0; h < s.length; h++)
                            ...
                            s[h].x.getTime() : s[h].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ga)))
                                if ("number" !== typeof s[h].y)
                                    ...
                                    this._eventManager.objectMap[aa] = {id: aa, objectType: "dataPoint",
                                        dataSeriesIndex: q, dataPointIndex: h, x1: r, y1: u};
        ...
        n.prototype.renderSplineArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                    var k = a.dataSeriesIndexes[h], m = this.data[k], p = m.dataPoints, l = m.id;
                    this._eventManager.objectMap[l] = {objectType: "dataSeries", dataSeriesIndex: k};
                    l = O(l);
                    e.fillStyle = l;
                    var l = [], q = 0, g, s, r = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), n, u = null, y = [];
                    if (0 < p.length) {
                        var x = m._colorSet[q % m._colorSet.length],
                                z = m.lineColor = m.options.lineColor || x, G = z;
                        b.fillStyle = x;
                        b.strokeStyle = z;
                        b.lineWidth = m.lineThickness;
                        var C = "solid";
                        if (b.setLineDash) {
                            var A = J(m.nullDataLineDashType, m.lineThickness), C = m.lineDashType, B = J(C, m.lineThickness);
                            b.setLineDash(B)
                        }
                        for (s = !1; q < p.length; q++)
                            if (g = p[q].x.getTime ? p[q].x.getTime() : p[q].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !s)))
                                if ("number" !== typeof p[q].y)
                                    0 < q && !s && (m.connectNullData ? b.setLineDash && (0 < y.length && (m.options.nullDataLineDashType ||
                                    ...
                                    (p[q].indexLabel || m.indexLabel || p[q].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({chartType: "splineArea", dataPoint: p[q], dataSeries: m,
                                        point: {x: g, y: s}, direction: 0 > p[q].y === a.axisY.reversed ? 1 : -1, color: x});
                                    s = !1
                                }
                        d();
                        $.drawMarkers(l)
        ...
        n.prototype.renderStepArea = function (a) {
            ...
            var e = a.targetCanvasCtx || this.plotArea.ctx, f = w ? this._preRenderCtx : e;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var l = this._eventManager.ghostCtx, t = a.axisY.lineCoordinates, h = [], k = this.plotArea, m;
                f.save();
                w && l.save();
                f.beginPath();
                f.rect(k.x1, k.y1, k.width, k.height);
                ...
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    var q =
                            a.dataSeriesIndexes[p], g = this.data[q], s = g.dataPoints, h = g.id;
                    this._eventManager.objectMap[h] = {objectType: "dataSeries", dataSeriesIndex: q};
                    h = O(h);
                    l.fillStyle = h;
                    h = [];
                    d = !0;
                    var r = 0, n, u, y, x = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), z, G = null;
                    c = !1;
                    if (0 < s.length) {
                        var C = g._colorSet[r % g._colorSet.length], v = g.lineColor = g.options.lineColor || C, A = v;
                        f.fillStyle = C;
                        f.strokeStyle = v;
                        f.lineWidth = g.lineThickness;
                        var M = "solid";
                        if (f.setLineDash) {
                            var T = J(g.nullDataLineDashType, g.lineThickness),
                                    M = g.lineDashType, E = J(M, g.lineThickness);
                            f.setLineDash(E)
                        }
                        for (; r < s.length; r++)
        ...
        n.prototype.renderStackedArea = function (a) {
            ...
            var c = a.targetCanvasCtx || this.plotArea.ctx, b = w ? this._preRenderCtx : c;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = null, l = [], t = this.plotArea, h = [], k = [], m = [], p = [], q = 0, g, s, r = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), n = this._eventManager.ghostCtx, u, y, x;
                w && n.beginPath();
                b.save();
                w && n.save();
                b.beginPath();
                ...
                for (var e = [], z = 0; z < a.dataSeriesIndexes.length; z++) {
                    var G =
                            a.dataSeriesIndexes[z], C = this.data[G], v = C.dataPoints;
                    C.dataPointIndexes = [];
                    for (q = 0; q < v.length; q++)
                        G = v[q].x.getTime ? v[q].x.getTime() : v[q].x, C.dataPointIndexes[G] = q, e[G] || (m.push(G), e[G] = !0);
                    m.sort(Ra)
                }
                for (z = 0; z < a.dataSeriesIndexes.length; z++) {
                    ...
                    n.fillStyle = q;
                    if (0 < m.length) {
                        var e = C._colorSet[0], A = C.lineColor = C.options.lineColor || e, M = A;
                        b.fillStyle = e;
                        b.strokeStyle = A;
                        ...
                        for (var aa = !0, q = 0; q < m.length; q++) {
                            var f = m[q], ha = null, ha = 0 <= C.dataPointIndexes[f] ? v[C.dataPointIndexes[f]] : {x: f, y: null};
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!C.connectNullData || !aa)))
                                if ("number" !== typeof ha.y)
                                    C.connectNullData || (aa || y) || d(), aa = !0;
                                else {
                                    ...
                                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) {
                                        ...
                                        s = a.axisY.convertValueToPixel(ha.y), s -= ma;
                                    k.push({x: g, y: r - ma});
                                    h[f] = r - s;
        ...
        n.prototype.renderStackedArea100 = function (a) {
            ...
            var c = a.targetCanvasCtx || this.plotArea.ctx, b = w ? this._preRenderCtx : c;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = null, l = this.plotArea, t = [], h = [], k = [], m = [], p = [], q = 0, g, s, r, n, u, y = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), x = this._eventManager.ghostCtx;
                b.save();
                w && x.save();
                b.beginPath();
                ...
                w && (x.beginPath(), x.rect(l.x1, l.y1, l.width,
                        l.height), x.clip());
                for (var e = [], z = 0; z < a.dataSeriesIndexes.length; z++) {
                    var G = a.dataSeriesIndexes[z], C = this.data[G], v = C.dataPoints;
                    C.dataPointIndexes = [];
                    for (q = 0; q < v.length; q++)
                        G = v[q].x.getTime ? v[q].x.getTime() : v[q].x, C.dataPointIndexes[G] = q, e[G] || (m.push(G), e[G] = !0);
                    m.sort(Ra)
                ...
                for (z = 0; z < a.dataSeriesIndexes.length; z++) {
                    ...
                    if (0 < m.length) {
                        var e =
                                C._colorSet[q % C._colorSet.length], A = C.lineColor = C.options.lineColor || e, M = A;
                        b.fillStyle = e;
                        b.strokeStyle = A;
                        b.lineWidth = C.lineThickness;
                        u = "solid";
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!C.connectNullData || !aa)))
                                if ("number" !== typeof ha.y)
                                    ...
                                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) {
                                        ...
                                        s = a.axisY.convertValueToPixel(ma), s -= B;
                                    k.push({x: g, y: y - B});
                                    h[f] = y - s;
                                    ...
                                    r = {x: g, y: s};
                                    q < v.length - 1 && (M !== (v[q].lineColor || A) || u !== (v[q].lineDashType || C.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, s), k.push({x: g, y: y -
                                        B}), M = v[q].lineColor || A, b.strokeStyle = M, b.setLineDash && (v[q].lineDashType ? (u = v[q].lineDashType, b.setLineDash(J(u, C.lineThickness))) : (u = C.lineDashType, b.setLineDash(E))));
                                    if (0 <= C.dataPointIndexes[f]) {
                    ...
                    if (m = a.dataSeriesIndexes[k], p = this.data[m], q = p.dataPoints, 0 < q.length)
                        for (c.strokeStyle = "#4572A7 ", e = 0; e < q.length; e++)
                            if (f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, !(f < a.axisX.dataInfo.viewPortMin ||
                                ...
                                var g = q[e].z, n = 2 * Math.max(Math.sqrt((t === h ? r / 2 : s + (r - s) / (t - h) * (g - h)) / Math.PI) << 0, 1), g = p.getMarkerProperties(e, c);
                                g.size = n;
        ...
        n.prototype.renderScatter = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
                    var h = a.dataSeriesIndexes[t], k = this.data[h], m = k.dataPoints;
                    if (0 < m.length) {
                        c.strokeStyle = "#4572A7 ";
        ...
        n.prototype.renderCandlestick = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = null, l = this.plotArea, t = 0, h, k, m, p, q, g, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, f = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ?
                        this.dataPointWidth : 0.015 * this.width, s = a.axisX.dataInfo.minDiff;
                isFinite(s) || (s = 0.3 * Math.abs(a.axisX.range));
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    var ca = a.dataSeriesIndexes[n], u = this.data[ca], y = u.dataPoints;
                    if (0 < y.length)
                        for (var x = 5 < s && u.bevelEnabled ? !0 : !1, t = 0; t < y.length; t++)
                            if (y[t].getTime ? g = y[t].x.getTime() : g = y[t].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !r(y[t].y) && y[t].y.length && "number" === typeof y[t].y[0] &&
                                ...
                                var z = h - s / 2 << 0, G = z + s << 0, f = u.options.fallingColor ? u.fallingColor : u._colorSet[0], e = y[t].color ? y[t].color : u._colorSet[0], C = Math.round(Math.max(1, 0.15 * s)), v = 0 === C % 2 ? 0 : 0.5, A = u.dataPointIds[t];
                                this._eventManager.objectMap[A] =
                                        {id: A, objectType: "dataPoint", dataSeriesIndex: ca, dataPointIndex: t, x1: z, y1: k, x2: G, y2: m, x3: h, y3: p, x4: h, y4: q, borderThickness: C, color: e};
                                c.strokeStyle = e;
                                c.beginPath();
                                c.lineWidth = C;
        ...
        n.prototype.renderBoxAndWhisker = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = this.plotArea,
                        l = 0, t, h, k, m, p, q, g, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, l = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.015 * this.width, s = a.axisX.dataInfo.minDiff;
                isFinite(s) || (s = 0.3 * Math.abs(a.axisX.range));
                ...
                for (var n = !1, n = !!a.axisY.reversed, ca = 0; ca < a.dataSeriesIndexes.length; ca++) {
                    var u = a.dataSeriesIndexes[ca], y = this.data[u], x = y.dataPoints;
                    if (0 < x.length)
                        for (var z = 5 < s && y.bevelEnabled ? !0 : !1, l = 0; l < x.length; l++)
                            if (x[l].getTime ? g = x[l].x.getTime() : g = x[l].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !r(x[l].y) && x[l].y.length && "number" === typeof x[l].y[0] && "number" === typeof x[l].y[1] && "number" === typeof x[l].y[2] && "number" === typeof x[l].y[3] && "number" === typeof x[l].y[4] && 5 === x[l].y.length) {
                                ...
                                var v = t - s / 2 << 0, C = t + s / 2 << 0, e = x[l].color ? x[l].color : y._colorSet[0], A = Math.round(Math.max(1, 0.15 * s)), B = 0 === A % 2 ? 0 : 0.5, M = x[l].whiskerColor ? x[l].whiskerColor : x[l].color ? y.whiskerColor ? y.whiskerColor : x[l].color : y.whiskerColor ? y.whiskerColor : e, T = "number" === typeof x[l].whiskerThickness ? x[l].whiskerThickness : "number" === typeof y.options.whiskerThickness ? y.whiskerThickness : A, E = x[l].whiskerDashType ? x[l].whiskerDashType : y.whiskerDashType,
                                        aa = r(x[l].whiskerLength) ? r(y.options.whiskerLength) ? s : y.whiskerLength : x[l].whiskerLength, aa = "number" === typeof aa ? 0 >= aa ? 0 : aa >= s ? s : aa : "string" === typeof aa ? parseInt(aa) * s / 100 > s ? s : parseInt(aa) * s / 100 : s, ha = 1 === Math.round(T) % 2 ? 0.5 : 0, ma = x[l].stemColor ? x[l].stemColor : x[l].color ? y.stemColor ? y.stemColor : x[l].color : y.stemColor ? y.stemColor : e, Ba = "number" === typeof x[l].stemThickness ? x[l].stemThickness : "number" === typeof y.options.stemThickness ? y.stemThickness : A, F = 1 === Math.round(Ba) % 2 ? 0.5 : 0, I = x[l].stemDashType ? x[l].stemDashType :
                                        y.stemDashType, K = x[l].lineColor ? x[l].lineColor : x[l].color ? y.lineColor ? y.lineColor : x[l].color : y.lineColor ? y.lineColor : e, P = "number" === typeof x[l].lineThickness ? x[l].lineThickness : "number" === typeof y.options.lineThickness ? y.lineThickness : A, R = x[l].lineDashType ? x[l].lineDashType : y.lineDashType, L = 1 === Math.round(P) % 2 ? 0.5 : 0, U = y.upperBoxColor, S = y.lowerBoxColor, qa = r(y.options.fillOpacity) ? 1 : y.fillOpacity, Q = y.dataPointIds[l];
                                this._eventManager.objectMap[Q] = {id: Q, objectType: "dataPoint", dataSeriesIndex: u, dataPointIndex: l,
                                    x1: v, y1: h, x2: C, y2: k, x3: t, y3: m, x4: t, y4: p, y5: q, borderThickness: A, color: e, stemThickness: Ba, stemColor: ma, whiskerThickness: T, whiskerLength: aa, whiskerColor: M, lineThickness: P, lineColor: K};
                                c.save();
                        ...
                        for (var s =
                            ...
                            if (g[f].getTime ? h = g[f].x.getTime() : h = g[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !r(g[f].y) && g[f].y.length && "number" === typeof g[f].y[0] && "number" === typeof g[f].y[1]) {
                                ...
                                var n = a.axisX.reversed ? b + a.plotType.totalDataSeries * k / 2 - (a.previousDataSeriesCount + m) * k << 0 : b - a.plotType.totalDataSeries * k / 2 + (a.previousDataSeriesCount +
                                        m) * k << 0, ca = a.axisX.reversed ? n - k << 0 : n + k << 0, b = g[f].color ? g[f].color : q._colorSet[f % q._colorSet.length];
                                if (l > t) {
                                    var u = l;
                                    l = t;
                                    t = u
                                ...
                                if (g[f].indexLabel || q.indexLabel || g[f].indexLabelFormatter ||
                                    ...
                                    this._indexLabels.push({chartType: "rangeColumn", dataPoint: g[f], dataSeries: q, indexKeyword: 0, point: {x: n + (ca - n) / 2, y: g[f].y[1] >= g[f].y[0] ? t : l}, direction: g[f].y[1] >= g[f].y[0] ? -1 : 1, bounds: {x1: n, y1: Math.min(l, t), x2: ca, y2: Math.max(l, t)}, color: b}), this._indexLabels.push({chartType: "rangeColumn", dataPoint: g[f], dataSeries: q, indexKeyword: 1, point: {x: n + (ca - n) / 2, y: g[f].y[1] >= g[f].y[0] ? l : t}, direction: g[f].y[1] >= g[f].y[0] ? 1 : -1, bounds: {x1: n, y1: Math.min(l, t), x2: ca, y2: Math.max(l, t)}, color: b})
                            }
                }
                w &&
                        (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.restore());
                c.restore();
                return{source: d, dest: this.plotArea.ctx, animationCallback: N.fadeInAnimation,
                    easingFunction: N.easing.easeInQuad, animationBase: 0}
            }
        };
        n.prototype.renderError = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = w ? this._preRenderCtx : d, b = a.axisY._position ? "left" === a.axisY._position || "right" === a.axisY._position ? !1 : !0 : !1;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = !1, l = this.plotArea, t = 0, h, k, m, p, q, g, s, n = a.axisX.dataInfo.minDiff;
                ...
                for (var ca = 0, u = 0; u < this.data.length; u++)
                    !this.data[u].type.match(/(bar|column)/ig) || !this.data[u].visible || this.data[u].type.match(/(stacked)/ig) && ca || ca++;
                for (var y = 0; y < a.dataSeriesIndexes.length; y++) {
                    var x = a.dataSeriesIndexes[y], z = this.data[x], v = z.dataPoints, C = r(z._linkedSeries) ? !1 : z._linkedSeries.type.match(/(bar|column)/ig) && z._linkedSeries.visible ? !0 : !1,
                            A = 0;
                    if (C)
                    ...
                    if (0 < v.length)
                        for (var E = z._colorSet, t = 0; t < v.length; t++) {
                            var e = z.lineColor = z.options.color ? z.options.color : E[0], M = {color: v[t].whiskerColor ? v[t].whiskerColor : v[t].color ? z.whiskerColor ? z.whiskerColor : v[t].color : z.whiskerColor ? z.whiskerColor : e, thickness: r(v[t].whiskerThickness) ? z.whiskerThickness : v[t].whiskerThickness, dashType: v[t].whiskerDashType ? v[t].whiskerDashType : z.whiskerDashType, length: r(v[t].whiskerLength) ?
                                        r(z.options.whiskerLength) ? u : z.options.whiskerLength : v[t].whiskerLength, trimLength: r(v[t].whiskerLength) ? r(z.options.whiskerLength) ? 50 : 0 : 0};
                            ...
                            var T = {color: v[t].stemColor ? v[t].stemColor : v[t].color ? z.stemColor ? z.stemColor : v[t].color : z.stemColor ? z.stemColor : e, thickness: v[t].stemThickness ?
                                v[t].stemThickness : z.stemThickness, dashType: v[t].stemDashType ? v[t].stemDashType : z.stemDashType};
                            ...
                            if (!(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax) && !r(v[t].y) && v[t].y.length && "number" === typeof v[t].y[0] && "number" === typeof v[t].y[1]) {
                                ...
                                b && m > p && (ga = m, m = p, p = ga);
                                ga = z.dataPointIds[t];
                                this._eventManager.objectMap[ga] = {id: ga, objectType: "dataPoint", dataSeriesIndex: x, dataPointIndex: t, x1: Math.min(m, p), y1: Math.min(q, g), x2: Math.max(p, m), y2: Math.max(g, q), isXYSwapped: b, stemProperties: T,
                                    whiskerProperties: M};
                                B(c, Math.min(m, p), Math.min(q, g), Math.max(p, m), Math.max(g, q), e, M, T, b);
                                w && B(this._eventManager.ghostCtx, m, q, p, g, e, M, T, b);
                                if (v[t].indexLabel || z.indexLabel || v[t].indexLabelFormatter || z.indexLabelFormatter)
                                    this._indexLabels.push({chartType: "error", dataPoint: v[t], dataSeries: z, indexKeyword: 0, point: {x: b ? v[t].y[1] >= v[t].y[0] ? m : p : m + (p - m) / 2, y: b ? q + (g - q) / 2 : v[t].y[1] >= v[t].y[0] ? g : q}, direction: v[t].y[1] >= v[t].y[0] ? -1 : 1, bounds: {x1: b ? Math.min(m, p) : m, y1: b ? q : Math.min(q, g), x2: b ? Math.max(m, p) : p, y2: b ?
        ...
        n.prototype.renderRangeBar = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx,
                    c = w ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = 0, l, t, h, k, f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                ...
                w && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip());
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    var q = a.dataSeriesIndexes[p], g = this.data[q], s = g.dataPoints;
                    if (0 < s.length) {
                        ...
                        for (f = 0; f < s.length; f++)
                            if (s[f].getTime ? k = s[f].x.getTime() : k = s[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !r(s[f].y) && s[f].y.length && "number" === typeof s[f].y[0] &&
                                ...
                                if (s[f].indexLabel || g.indexLabel || s[f].indexLabelFormatter || g.indexLabelFormatter)
                                    this._indexLabels.push({chartType: "rangeBar", dataPoint: s[f], dataSeries: g, indexKeyword: 0, point: {x: s[f].y[1] >= s[f].y[0] ? l : t, y: h + (v - h) / 2}, direction: s[f].y[1] >= s[f].y[0] ? -1 : 1, bounds: {x1: Math.min(l,
                                                    t), y1: h, x2: Math.max(l, t), y2: v}, color: b}), this._indexLabels.push({chartType: "rangeBar", dataPoint: s[f], dataSeries: g, indexKeyword: 1, point: {x: s[f].y[1] >= s[f].y[0] ? t : l, y: h + (v - h) / 2}, direction: s[f].y[1] >= s[f].y[0] ? 1 : -1, bounds: {x1: Math.min(l, t), y1: h, x2: Math.max(l, t), y2: v}, color: b})
                            }
                    }
                }
        ...
        n.prototype.renderRangeArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
                    var h = [], k = a.dataSeriesIndexes[t], m = this.data[k], p = m.dataPoints, f = m.id;
                    this._eventManager.objectMap[f] = {objectType: "dataSeries", dataSeriesIndex: k};
                    f = O(f);
                    e.fillStyle = f;
                    var f = [], q = !0, g = 0, s, r, n, u, y = null;
                    if (0 < p.length) {
                        var x = m._colorSet[g % m._colorSet.length], v = m.lineColor = m.options.lineColor || x, A = v;
                        b.fillStyle = x;
                        b.strokeStyle =
                                v;
                        b.lineWidth = m.lineThickness;
                        var C = "solid";
                        if (b.setLineDash) {
                            var B = J(m.nullDataLineDashType, m.lineThickness), C = m.lineDashType, E = J(C, m.lineThickness);
                            b.setLineDash(E)
                        }
                            ...
                            if (u = p[g].x.getTime ? p[g].x.getTime() : p[g].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !M)))
                                if (null !== p[g].y && p[g].y.length && "number" === typeof p[g].y[0] && "number" === typeof p[g].y[1]) {
                                    ...
                                    this._eventManager.objectMap[u] =
                                            {id: u, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: g, x1: s, y1: r, y2: n};
                                    ...
                                    if (p[g].indexLabel || m.indexLabel || p[g].indexLabelFormatter || m.indexLabelFormatter)
                                        this._indexLabels.push({chartType: "rangeArea", dataPoint: p[g], dataSeries: m,
                                            indexKeyword: 0, point: {x: s, y: r}, direction: p[g].y[0] > p[g].y[1] === a.axisY.reversed ? -1 : 1, color: x}), this._indexLabels.push({chartType: "rangeArea", dataPoint: p[g], dataSeries: m, indexKeyword: 1, point: {x: s, y: n}, direction: p[g].y[0] > p[g].y[1] === a.axisY.reversed ? 1 : -1, color: x})
                                } else
                                    M || q || d(), M = !0;
                        d();
                        $.drawMarkers(f)
        ...
        n.prototype.renderRangeSplineArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                w && (e.beginPath(), e.rect(l.x1, l.y1, l.width,
                        l.height), e.clip());
                for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                    var r = a.dataSeriesIndexes[h], k = this.data[r], m = k.dataPoints, f = k.id;
                    this._eventManager.objectMap[f] = {objectType: "dataSeries", dataSeriesIndex: r};
                    f = O(f);
                    e.fillStyle = f;
                    var f = [], p = 0, q, g, s, n = [], ca = [];
                    if (0 < m.length) {
                        ...
                        var z = "solid", A;
                        if (b.setLineDash) {
                            var C = J(k.nullDataLineDashType, k.lineThickness), z = k.lineDashType;
                            A = J(z,
                                    k.lineThickness)
                        }
                        for (g = !1; p < m.length; p++)
                            if (q = m[p].x.getTime ? m[p].x.getTime() : m[p].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !g)))
                                if (null !== m[p].y && m[p].y.length && "number" === typeof m[p].y[0] && "number" === typeof m[p].y[1]) {
                                    ...
                                    this._eventManager.objectMap[B] = {id: B, objectType: "dataPoint", dataSeriesIndex: r, dataPointIndex: p,
                                        x1: q, y1: g, y2: s};
                                    n[n.length] = {x: q, y: g};
                                    ...
                                    if (0 !== m[p].markerSize && (0 < m[p].markerSize || 0 < k.markerSize)) {
                                        ...
                                        f.push(I);
                                        var M = O(B);
                                        w && f.push({x: q, y: g, ctx: e,
                                            type: I.type, size: I.size, color: M, borderColor: M, borderThickness: I.borderThickness});
                                    ...
                                    if (m[p].indexLabel || k.indexLabel || m[p].indexLabelFormatter || k.indexLabelFormatter)
                                        this._indexLabels.push({chartType: "rangeSplineArea", dataPoint: m[p], dataSeries: k, indexKeyword: 0, point: {x: q, y: g}, direction: m[p].y[0] <= m[p].y[1] ? -1 : 1, color: u}), this._indexLabels.push({chartType: "rangeSplineArea",
                                            dataPoint: m[p], dataSeries: k, indexKeyword: 1, point: {x: q, y: s}, direction: m[p].y[0] <= m[p].y[1] ? 1 : -1, color: u});
                                    g = !1
                                } else
                                    0 < p && !g && (k.connectNullData ? b.setLineDash && (0 < n.length && (k.options.nullDataLineDashType || !m[p - 1].lineDashType)) && (n[n.length - 1].newLineDashArray = C, z = k.nullDataLineDashType) : (d(A, y), n = [], ca = [])), g = !0;
                        d(A, y);
                        $.drawMarkers(f)
                    }
                }
        ...
        n.prototype.renderWaterfall = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx,
                    c = w ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = this._eventManager.ghostCtx, e = null, f = this.plotArea, l = 0, h, r, k, m, p = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), l = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                ...
                for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
                    var s = a.dataSeriesIndexes[g], n = this.data[s], v = n.dataPoints, e = n._colorSet[0];
                    ...
                    var u = "number" === typeof n.options.lineThickness ? Math.round(n.lineThickness) : 1, y = 1 === Math.round(u) % 2 ? -0.5 : 0;
                    if (0 < v.length)
                        for (var x = 5 < q && n.bevelEnabled ? !0 : !1, z = !1, A = null, C = null, l = 0; l < v.length; l++)
                            if (v[l].getTime ? m = v[l].x.getTime() : m = v[l].x, "number" !== typeof v[l].y) {
                                if (0 < l && !z && n.connectNullData)
                                    var B = n.options.nullDataLineDashType || !v[l - 1].lineDashType ? n.nullDataLineDashType : v[l - 1].lineDashType;
                                z = !0
                            } else {
        ...
        n.prototype.renderPie = function (a) {
            function d() {
                if (k && m) {
                    for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < m.length; e++) {
                        var f = m[e], l = k.dataPointIds[e];
                        g[e].id = l;
                        g[e].objectType = "dataPoint";
                        g[e].dataPointIndex =
                                e;
                        g[e].dataSeriesIndex = 0;
                        var h = g[e], p = {percent: null, total: null}, t = null, p = n.getPercentAndTotal(k, f);
                        if (k.indexLabelFormatter || f.indexLabelFormatter)
                            t = {chart: n.options, dataSeries: k, dataPoint: f, total: p.total, percent: p.percent};
                        ...
                        if (h.midAngle > Math.PI / 2 - u && h.midAngle < Math.PI / 2 + u) {
                            if (0 === a || g[c].midAngle > h.midAngle)
                                c = e;
                            a++
                        } else if (h.midAngle > 3 * Math.PI / 2 - u && h.midAngle < 3 * Math.PI / 2 + u) {
                            if (0 === b || g[d].midAngle > h.midAngle)
                                d = e;
                            b++
                        }
                        h.hemisphere = f > Math.PI / 2 && f <= 3 * Math.PI / 2 ? "left" : "right";
                        h.indexLabelTextBlock = new ka(n.plotArea.ctx, {fontSize: h.indexLabelFontSize, fontFamily: h.indexLabelFontFamily,
                            fontColor: h.indexLabelFontColor, fontStyle: h.indexLabelFontStyle, fontWeight: h.indexLabelFontWeight, textAlign: h.indexLabelTextAlign, backgroundColor: h.indexLabelBackgroundColor, maxWidth: h.indexLabelMaxWidth, maxHeight: h.indexLabelWrap ? 5 * h.indexLabelFontSize : 1.5 * h.indexLabelFontSize, text: h.indexLabelText, padding: 0, textBaseline: "top"});
                        h.indexLabelTextBlock.measureText()
                    }
                    l = f = 0;
                    p = !1;
                    for (e = 0; e < m.length; e++)
                        h = g[(c + e) % m.length], 1 < a && (h.midAngle > Math.PI / 2 - u && h.midAngle < Math.PI / 2 + u) && (f <= a / 2 && !p ? (h.hemisphere =
            ...
            function c(a) {
                ...
                for (b = 0; b < m.length; b++) {
                    ...
                    if (d > c) {
                        var e = 0.07 * C * Math.cos(g[b].midAngle), f = 0.07 * C * Math.sin(g[b].midAngle), l =
                                !1;
                        if (m[b].exploded) {
                            if (1E-9 < Math.abs(g[b].center.x - (x.x + e)) || 1E-9 < Math.abs(g[b].center.y - (x.y + f)))
                                g[b].center.x = x.x + e * a, g[b].center.y = x.y + f * a, l = !0
                        } else if (0 < Math.abs(g[b].center.x - x.x) || 0 < Math.abs(g[b].center.y - x.y))
                            g[b].center.x = x.x + e * (1 - a), g[b].center.y = x.y + f * (1 - a), l = !0;
                ...
                for (var c = null, d = 1; d < m.length; d++)
                    if (c = (a + d + g.length) % g.length, g[c].hemisphere !== g[a].hemisphere) {
                        ...
                        break
                            ...
                            a && (0 > b(g[c], g[a]) || ("right" === g[a].hemisphere ? g[c].indexLabelTextBlock.y >= g[a].indexLabelTextBlock.y : g[c].indexLabelTextBlock.y <= g[a].indexLabelTextBlock.y)))
                        break;
                    else
                        c = null;
                return c
                ...
                if (0 <= a && a < m.length) {
                    ...
                    for (h = 1; h < m.length; h++)
                        if (k = (a - h + g.length) % g.length, g[k].hemisphere !== g[a].hemisphere) {
                            k = null;
                            break
                        } else if (g[k].indexLabelText && g[k].hemisphere === g[a].hemisphere && k !== a && (0 > b(g[k], g[a]) || ("right" === g[a].hemisphere ? g[k].indexLabelTextBlock.y <= g[a].indexLabelTextBlock.y : g[k].indexLabelTextBlock.y >= g[a].indexLabelTextBlock.y)))
                            break;
                        else
                            k = null;
                    t = k;
            ...
            function l() {
                ...
                for (var c = a = 0, d = 0, l = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
                    if (k.radius || !k.radius && "undefined" !== typeof k.innerRadius && null !== k.innerRadius && C - d <= B)
                        l = !1;
                    l && (C -= d);
                    d = 0;
                    if ("inside" !== k.indexLabelPlacement) {
                        ...
                        for (a = 0; a < m.length; a++)
                            h = g[a], w = "pie" === k.type ? 0.7 * C : 0.85 * C, u = x.x + w * Math.cos(h.midAngle),
                            ...
                            if (f = !1, t = g[k], t.indexLabelText) {
                                ...
                                if (null !== l) {
                                    ...
                                    if (q = 0 > z) {
                                        ...
                                        var n = t.indexLabelTextBlock.y - t.indexLabelTextBlock.height / 2, r = t.indexLabelTextBlock.y + t.indexLabelTextBlock.height / 2, s = h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2, u = h.indexLabelTextBlock.x + h.indexLabelTextBlock.width, D = h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2;
                                        q = t.indexLabelTextBlock.x +
            ...
            var n = this;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var k = this.data[a.dataSeriesIndexes[0]], m = k.dataPoints, p = 10, q = this.plotArea, g = k.dataPointEOs, s = 2, w, v = 1.3, u = 20 / 180 * Math.PI, y = 6, x = {x: (q.x2 + q.x1) / 2, y: (q.y2 + q.y1) / 2}, z = 0;
                a = !1;
                for (var A = 0; A < m.length; A++)
                    z += Math.abs(m[A].y), !a && ("undefined" !== typeof m[A].indexLabel &&
        ...
        n.prototype.renderFunnel = function (a) {
            function d() {
                ...
                for (c = b[0] = 0; c < y.length; c++)
                    b.push(Math.abs(y[c].y) *
                            E / a);
                return b
            }
            function c() {
                var a = X, b = Z, c = L, d = $, e, f;
                e = P;
                f = R - O;
                ...
                for (var l = d[0] = 0, h = 0, m, p, b = b - a, l = !1, k = 0; k < y.length; k++)
                    a = Math.abs(y[k].y) * f / g, l ? m = 0 == Number(c.toFixed(3)) ? 0 : a / c : (p = ba * ba * b * b - 4 * Math.abs(ba) * a, 0 > p ? (p = c, l = (b + p) * (e - h) / 2, a -= l, m = e - h, h += e - h, m += 0 == p ? 0 : a / p, h += a / p, l = !0) :
            ...
            function b() {
                if (u && y) {
                    for (var a, b, c, d, e, f, k, l, h, m, p, q, t, n, s, D = [], x = [], v = {percent: null, total: null}, z = null, C = 0; C < y.length; C++)
                        s = Q[C], s = "undefined" !== typeof s.x5 ? (s.y2 + s.y4) / 2 : (s.y2 + s.y3) / 2, s = g(s).x2 + 1, D[C] = K - s - S;
                    s = 0.5 * S;
                    for (var C = 0, B = y.length - 1; C < y.length || 0 <= B; C++, B--) {
                        ...
                        t = u.dataPointIds[C];
                        A._eventManager.objectMap[t] = {id: t, objectType: "dataPoint", dataPointIndex: C,
                            dataSeriesIndex: 0, funnelSection: Q[u.reversed ? y.length - 1 - C : C]};
                        ...
                        if (u.indexLabelFormatter || b.indexLabelFormatter)
                            z =
                                    {chart: A.options, dataSeries: u, dataPoint: b, total: v.total, percent: v.percent};
                        ...
                        U.roundRect || Da(U);
                        c = new ka(U, {fontSize: f, fontFamily: l, fontColor: e, fontStyle: k, fontWeight: h, horizontalAlign: c, textAlign: n, backgroundColor: d, maxWidth: t, maxHeight: !1 ===
                            x[C] ? q ? 4.28571429 * f : 1.5 * f : x[C], text: b, padding: ea});
                        c.measureText();
            ...
            function f() {
                ...
                if ("inside" !== u.indexLabelPlacement)
                    for (var e = 0; e < Q.length; e++)
                        0 == H[e].textBlock.text.length ? H[e].isDirty = !0 : (a = Q[e], c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2, b = u.reversed ? "undefined" !== typeof a.x5 ? c >
            ...
            function l() {
                ...
                function b() {
                    ...
                    for (var l, h = 1; h < k; h++) {
                        ...
                        for (var t = H.length - 1; 0 <= t; t--)
                            !H[t].isDirty && (H[t].textBlock.y < e && H[t].textBlock.y + H[t].height > e) && (l = q(t), !(l >= H.length - 1) && H[t].textBlock.y + H[t].height + ea > H[l].textBlock.y && (H[t].textBlock.y = H[t].textBlock.y + H[t].height - e > e - H[t].textBlock.y ? e + 1 : e - H[t].height - 1))
                    }
                    for (l = Q.length - 1; 0 < l; l--)
                        if (!H[l].isDirty) {
                            e = p(l);
                            if (0 > e && (e = 0, H[e].isDirty))
                                break;
                ...
                function c(a, b, d) {
                    ...
                    for (d = 0; d < e.length; d++)
                        if (b = e[d], f < a)
                            g++, f += H[b.id].height + ea, H[b.id].textBlock.text = "", H[b.id].indexLabelText = "", H[b.id].isDirty =
                                    !0, H[b.id].textBlock.measureText();
                        else
                            break;
                    return g
                }
            ...
            function h(a, b) {
                return(b < Q.length ? H[b].textBlock.y : u.reversed ? V + z : qa + z) - (0 > a ? u.reversed ? qa - z : V - z : H[a].textBlock.y + H[a].height + ea)
            }
            function n(a,
                    b, c) {
                var d, e, g, l = [], h = z, p = [];
                ...
                if (0 === W.length)
                    ...
                    for (var q = 0; q < Q.length; q++) {
                        if (1 == W.length && 0 == W[0]) {
                            ...
                            0 === q && (d = -1 * h);
                        l.push(ia[q] + d);
                        if (0 <= W.indexOf(q) || q < Q.length && 0 <= W.indexOf(q + 1))
                            d += e
                    }
                }
                g = function () {
                ...
                var t = {startTime: (new Date).getTime(),
            ...
            function m(a) {
                for (var b, c, d, e, f = 0; f < Q.length; f++)
                    e = 1 === H[f].lineThickness % 2 ? 0.5 : 0, c = ((Q[f].y2 + Q[f].y4) /
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                for (var u = this.data[a.dataSeriesIndexes[0]], y = u.dataPoints, x = this.plotArea, z = 0.025 * x.width, B = 0.01 * x.width,
                    ...
                    if (!M && ("undefined" !== typeof y[T].indexLabel && null !== y[T].indexLabel && 0 < y[T].indexLabel.toString().length) && (M = !0), !M && ("undefined" !== typeof y[T].label && null !== y[T].label && 0 < y[T].label.toString().length) && (M = !0), !M && "function" === typeof u.indexLabelFormatter || "function" === typeof y[T].indexLabelFormatter)
                        M = !0;
                ...
                var T = x.x1 + B, K = x.x2 - B, P = x.y1 + z, R = x.y2 - z, U = a.targetCanvasCtx || this.plotArea.ctx || this.ctx;
                if (0 != u.length && (u.dataPoints && u.visible) && 0 !== y.length) {
                    ...
                    var B = T + a / 2, X = T, Z = T + a, V = u.reversed ? R : P, L = B - F / 2, $ = B + F / 2, Ca = u.reversed ? P + O : R - O, qa = u.reversed ? P : R;
                    a = [];
                    var B = [], Q = [], I = [], Y = P, da, ba = (Ca - V) / (L - X), fa = -ba, T = "area" === (u.valueRepresents ? u.valueRepresents : "height") ? c() : d();
                    if (-1 !== T) {
                        if (u.reversed)
                            for (I.push(Y), F = T.length - 1; 0 < F; F--)
                                Y += T[F], I.push(Y);
                        else
                        ...
                        if (u.reversed)
                            for (F = 0; F < T.length; F++)
                                I[F] < Ca ? (a.push(L), B.push($), da = F) : (a.push((I[F] - V + ba * X) /
                                        ba), B.push((I[F] - V + fa * Z) / fa));
                        else
                            for (F = 0; F < T.length; F++)
                                I[F] < Ca ? (a.push((I[F] - V + ba * X) / ba), B.push((I[F] - V + fa * Z) / fa), da = F) : (a.push(L), B.push($));
                        for (F = 0; F < T.length - 1; F++)
                            Y = u.reversed ? y[y.length - 1 - F].color ? y[y.length - 1 - F].color : u._colorSet[(y.length - 1 - F) % u._colorSet.length] : y[F].color ? y[F].color : u._colorSet[F % u._colorSet.length], F === da ? Q.push({x1: a[F], y1: I[F], x2: B[F], y2: I[F], x3: $, y3: Ca, x4: B[F + 1], y4: I[F + 1], x5: a[F + 1], y5: I[F + 1], x6: L, y6: Ca, id: F, height: I[F + 1] - I[F], color: Y}) : Q.push({x1: a[F], y1: I[F], x2: B[F],
                                y2: I[F], x3: B[F + 1], y3: I[F + 1], x4: a[F + 1], y4: I[F + 1], id: F, height: I[F + 1] - I[F], color: Y});
                        var ea = 2, H = [], ja = !1, W = [], ia = [], T = !1;
                        a = a = 0;
                        Ea(W);
                        for (F = 0; F < y.length; F++)
                            y[F].exploded && (T = !0, u.reversed ? W.push(y.length - 1 - F) : W.push(F));
                        ...
                        for (F = 0; F < Q.length; F++)
                            C = Q[F], oa(U, C, u.fillOpacity), ia.push(C.y1);
                        v(U);
                        M && u.visible && ("inside" === u.indexLabelPlacement || A.animationEnabled || m(U), A.animationEnabled || s());
                        if (!M)
                            for (F = 0; F < y.length; F++)
                                C = u.dataPointIds[F], a = {id: C, objectType: "dataPoint", dataPointIndex: F, dataSeriesIndex: 0, funnelSection: Q[u.reversed ? y.length - 1 - F : F]}, A._eventManager.objectMap[C] = a;
                        !A.animationEnabled && T ? n(A,
                        ...
                        this.funnelPyramidClickHandler = function (a) {
                            ...
                            if (!ja && !A.isAnimating && (r(a.dataSeries.explodeOnClick) || a.dataSeries.explodeOnClick) && (b = u.reversed ? y.length - 1 - a.dataPointIndex : a.dataPointIndex, 0 <= b)) {
                                ...
                                if ("funnel" === u.type || "pyramid" === u.type)
                                    u.reversed ? y[y.length - 1 - a].exploded = y[y.length - 1 - a].exploded ? !1 : !0 : y[a].exploded = y[a].exploded ? !1 : !0;
                                n(A, b, 500)
                            }
                        };
                        return{source: U, dest: this.plotArea.ctx, animationCallback: function (a, b) {
                                N.fadeInAnimation(a,
                                        b);
        ...
        n.prototype.exportChart = function (a) {
            ...
            if (b && d && c) {
                c = c + "." + d;
                a = "image/" + d;
                var b = b.toDataURL(a), e = !1,
                        f = document.createElement("a");
                f.download = c;
                f.href = b;
                if ("undefined" !== typeof Blob && new Blob) {
                    for (var l = b.replace(/^data:[a-z\/]*;base64,/, ""), l = atob(l), h = new ArrayBuffer(l.length), h = new Uint8Array(h), n = 0; n < l.length; n++)
                        h[n] = l.charCodeAt(n);
        ...
        n.prototype.print = function () {
            ...
            S(d, {position: "absolute", width: "100%", border: "0px", margin: "0px 0px 0px 0px",
        ...
        n.prototype.replaceKeywordsWithValue =
                function (a, d, c, b, e) {
                    ...
                    if ((0 <= c.type.indexOf("stacked") || "pie" === c.type || "doughnut" === c.type || "funnel" === c.type || "pyramid" === c.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
                        var l = "#percent", h = "#total", n = this.getPercentAndTotal(c, d), h = isNaN(n.total) ? h : n.total, l = isNaN(n.percent) ? l : n.percent;
                        do {
                            n = "";
                            if (c.percentFormatString)
                                n = c.percentFormatString;
                            else {
                                var n = "#,##0.", k = Math.max(Math.ceil(Math.log(1 / Math.abs(l)) / Math.LN10), 2);
                    ...
                    return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function (a) {
                        ...
                        g = null;
                        if ("color" === a)
                            return"waterfall" === c.type ? d.color ? d.color : 0 < d.y ? c.risingColor : c.fallingColor : "error" === c.type ? c.color ? c.color : c._colorSet[l % c._colorSet.length] : d.color ? d.color : c.color ? c.color : c._colorSet[b % c._colorSet.length];
        ...
        R.prototype.setLayout = function () {
            var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, d = a.layoutManager.getFreeSpace(), c = null, b = 0, e = 0, f = 0, l = 0, h = this.markerMargin = this.chart.options.legend && !r(this.chart.options.legend.markerMargin) ? this.chart.options.legend.markerMargin : 0.3 * this.fontSize;
            this.height = 0;
            var n = [], k = [];
                ...
                if (p.dataPoints && p.dataPoints.length)
                    if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !== p.type && "pyramid" !== p.type) {
                        var q = p.legendMarkerType = p.legendMarkerType ? p.legendMarkerType : "line" !== p.type && "stepLine" !== p.type && "spline" !== p.type && "scatter" !== p.type && "bubble" !== p.type || !p.markerType ? "error" === p.type && p._linkedSeries ? p._linkedSeries.legendMarkerType ? p._linkedSeries.legendMarkerType : U.getDefaultLegendMarker(p._linkedSeries.type) :
                                U.getDefaultLegendMarker(p.type) : p.markerType, g = p.legendText ? p.legendText : this.itemTextFormatter ? this.itemTextFormatter({chart: this.chart, legend: this.options, dataSeries: p, dataPoint: null}) : p.name, s = p.legendMarkerColor = p.legendMarkerColor ? p.legendMarkerColor : p.markerColor ? p.markerColor : "error" === p.type ? r(p.whiskerColor) ? p._colorSet[0] : p.whiskerColor : p._colorSet[0], w = p.markerSize || "line" !== p.type && "stepLine" !== p.type && "spline" !== p.type ? 0.75 * this.lineHeight : 0, v = p.legendMarkerBorderColor ? p.legendMarkerBorderColor :
                                p.markerBorderColor, u = p.legendMarkerBorderThickness ? p.legendMarkerBorderThickness : p.markerBorderThickness ? Math.max(1, Math.round(0.2 * w)) : 0;
                        ...
                        for (var y = 0; y < p.dataPoints.length; y++) {
                            var x =
                                    p.dataPoints[y], q = x.legendMarkerType ? x.legendMarkerType : p.legendMarkerType ? p.legendMarkerType : U.getDefaultLegendMarker(p.type), g = x.legendText ? x.legendText : p.legendText ? p.legendText : this.itemTextFormatter ? this.itemTextFormatter({chart: this.chart, legend: this.options, dataSeries: p, dataPoint: x}) : x.name ? x.name : "DataPoint: " + (y + 1), s = x.legendMarkerColor ? x.legendMarkerColor : p.legendMarkerColor ? p.legendMarkerColor : x.color ? x.color : p.color ? p.color : p._colorSet[y % p._colorSet.length], w = 0.75 * this.lineHeight, v = x.legendMarkerBorderColor ?
                                ...
                                markerBorderColor: v, markerBorderThickness: u};
                ...
                for (m = 0; m < n.length; m++) {
                    ...
                    if (!(0 >= l || "undefined" === typeof l || 0 >= v || "undefined" === typeof v)) {
                        if ("horizontal" === this.orientation) {
                            ...
                            q.textBlock = new ka(this.ctx, {x: 0, y: 0, maxWidth: x, maxHeight: !0 === this.itemWrap ? l : 1.5 * this.fontSize, angle: 0, text: q.text,
                                horizontalAlign: "left", fontSize: this.fontSize, fontFamily: this.fontFamily, fontWeight: this.fontWeight, fontColor: this.fontColor, fontStyle: this.fontStyle, textBaseline: "middle"}), q.textBlock.measureText(), null !== this.itemWidth && (q.textBlock.width = this.itemWidth - (w + h + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0))), this.height < l - this.lineHeight ? (p = {items: [], width: 0}, k.push(p)) : (p = k[y], y = (y + 1) % k.length), this.height += q.textBlock.height;
            ...
            for (m = 0; m < this.items.length; m++)
                q = n[m], q.id = ++this.chart._eventManager.lastObjectId, this.chart._eventManager.objectMap[q.id] = {id: q.id, objectType: "legendItem", legendItemIndex: m, dataSeriesIndex: q.dataSeriesIndex, dataPointIndex: q.dataPointIndex};
            this.markerSize = w;
            this.rows = k;
        ...
        R.prototype.render = function () {
            var a = this.bounds.x1, d = this.bounds.y1,
                    c = this.markerMargin, b = this.maxWidth, e = this.maxHeight, f = this.markerSize, l = this.rows;
            ...
            for (var h = 0, n = 0; n < l.length; n++) {
                for (var k = l[n], m = 0, p = 0; p < k.items.length; p++) {
                    var q = k.items[p], g = q.textBlock.x + a + (0 === p ? 0.2 * f : this.horizontalSpacing), s = d + h, r = g;
                    ...
                    if ("line" === q.chartType || "stepLine" === q.chartType || "spline" === q.chartType)
                        this.ctx.strokeStyle = q.lineColor, this.ctx.lineWidth = Math.ceil(this.lineHeight / 8), this.ctx.beginPath(), this.ctx.moveTo(g - 0.1 * this.lineHeight, s + this.lineHeight / 2), this.ctx.lineTo(g + 0.85 * this.lineHeight, s + this.lineHeight / 2), this.ctx.stroke(), r -= 0.1 * this.lineHeight;
                    if ("error" === q.chartType) {
                        this.ctx.strokeStyle = this.errorMarkerColor[0];
                        this.ctx.lineWidth = f / 8;
                        this.ctx.beginPath();
                        var w = g - 0.08 * this.lineHeight + 0.1 * this.lineHeight, u = s + 0.15 * this.lineHeight, v = 0.7 * this.lineHeight, x = v + 0.02 * this.lineHeight;
                        this.ctx.moveTo(w, u);
        ...
        U.prototype.getDataPointAtX = function (a, d) {
            if (!this.dataPoints || 0 === this.dataPoints.length)
                return null;
            var c = {dataPoint: null, distance: Infinity, index: NaN}, b = null, e = 0, f = 0, l = 1, h = Infinity,
                    n = 0, k = 0, m = 0;
            ...
            for (; ; ) {
                ...
                if (0 <= f && f < this.dataPoints.length) {
                    var b =
                            this.dataPoints[f], p = this.axisX.logarithmic ? b.x > a ? b.x / a : a / b.x : Math.abs(b.x - a);
        ...
        U.prototype.getDataPointAtXY = function (a, d, c) {
            if (!this.dataPoints || 0 === this.dataPoints.length || a < this.chart.plotArea.x1 ||
                    a > this.chart.plotArea.x2 || d < this.chart.plotArea.y1 || d > this.chart.plotArea.y2)
                return null;
            c = c || !1;
            var b = [], e = 0, f = 0, l = 1, h = !1, n = Infinity, k = 0, m = 0, p = 0;
            if ("none" !== this.chart.plotInfo.axisPlacement)
                if (p = (this.chart.axisX[0] ? this.chart.axisX[0] : this.chart.axisX2[0]).getXValueAt({x: a, y: d}), this.axisX.logarithmic)
                    var q = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x), p = 1 < q ? Math.min(Math.max((this.dataPoints.length - 1) / q * Math.log(p / this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) :
                            0;
                else
                ...
                if (0 <= f && f < this.dataPoints.length) {
                    ...
                    if (q) {
                        switch (this.type) {
                            ...
                            case "splineArea":
                            case "scatter":
                                var r = la("markerSize", g, this) || 4, w = c ? 20 : r, s = Math.sqrt(Math.pow(q.x1 - a, 2) + Math.pow(q.y1 - d, 2));
                            ...
                            case "rangeSplineArea":
                                ...
                                s <= r / 2 && (b.push({dataPoint: g, dataPointIndex: f, dataSeries: this,
                                    distance: s}), h = !0);
                                break;
                                case "pie":
                            case "doughnut":
                                ...
                                s < q.radius && s > w && (s = Math.atan2(d - r.y, a - r.x), 0 > s && (s += 2 * Math.PI), s = Number(((180 * (s / Math.PI) % 360 + 360) % 360).toFixed(12)), r = Number(((180 * (q.startAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), w = Number(((180 * (q.endAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), 0 === w && 1 < q.endAngle && (w = 360), r >= w && 0 !== g.y && (w += 360, s < r && (s += 360)), s > r && s < w && (b.push({dataPoint: g,
                                    dataPointIndex: f, dataSeries: this, distance: 0}), h = !0));
                                break;
                                case "funnel":
                            case "pyramid":
                                s = q.funnelSection;
                                ...
                                case "boxAndWhisker":
                                if (a >=
                                        q.x1 - q.borderThickness / 2 && a <= q.x2 + q.borderThickness / 2 && d >= q.y4 - q.borderThickness / 2 && d <= q.y1 + q.borderThickness / 2 || Math.abs(q.x2 - a + q.x1 - a) < q.borderThickness && d >= q.y1 && d <= q.y4)
                                ...
                                if (Math.abs(q.x2 - a + q.x1 - a) < q.borderThickness && d >= q.y2 && d <= q.y3 || a >= q.x1 && a <= (q.x2 + q.x1) / 2 && d >= q.y1 - q.borderThickness / 2 && d <= q.y1 + q.borderThickness / 2 || a >= (q.x1 + q.x2) / 2 && a <= q.x2 && d >= q.y4 - q.borderThickness / 2 && d <= q.y4 + q.borderThickness / 2)
                                    b.push({dataPoint: g, dataPointIndex: f, dataSeries: this, distance: Math.min(Math.abs(q.x1 - a),
                                                Math.abs(q.x2 - a), Math.abs(q.y2 - d), Math.abs(q.y3 - d))}), h = !0
                            }
                        if (h || 1E3 < k && 1E3 < m)
                            break
                    }
        ...
        U.prototype.getMarkerProperties = function (a, d, c, b) {
            var e = this.dataPoints, f = e[a].markerColor ? e[a].markerColor : this.markerColor ? this.markerColor : e[a].color ? e[a].color : this.color ? this.color : this._colorSet[a % this._colorSet.length], l = e[a].markerBorderColor ? e[a].markerBorderColor :
                    this.markerBorderColor ? this.markerBorderColor : null, h = r(e[a].markerBorderThickness) ? this.markerBorderThickness ? this.markerBorderThickness : null : e[a].markerBorderThickness, n = e[a].markerType ? e[a].markerType : this.markerType;
        ...
        A.prototype.createLabels = function () {
            var a, d, c = 0, b = 0, e, f = 0, l = 0, b = 0, b = this.interval, h = 0, n, k = 0.6 * this.chart.height, m;
            a = !1;
            ...
            if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
                ...
                if (this.logarithmic && !this.equidistantInterval)
                    for (this.logLabelValues || (this.logLabelValues = [], this.createExtraLabelsForLog()),
                        ...
                        if (c = this.logLabelValues[b], c < this.viewportMinimum)
                            ...
                            m = c;
                            a || (a = this.labelFormatter ? this.labelFormatter({chart: this.chart, axis: this.options, value: m, label: this.labels[m] ? this.labels[m] : null}) : "axisX" === this.type && this.labels[m] ? this.labels[m] : fa(m, this.valueFormatString, this.chart._cultureInfo), a = new ka(this.ctx, {x: 0, y: 0, maxWidth: f, maxHeight: l, angle: this.labelAngle,
                ...
                for (this.intervalStartPosition = this.getLabelStartPoint(new Date(this.viewportMinimum), this.intervalType, this.interval), e = Xa(new Date(this.viewportMaximum), this.interval, this.intervalType), g = q, c = this.intervalStartPosition; c < e; Xa(c, b, this.intervalType)) {
                    ...
                    a || (a = this.labelFormatter ? this.labelFormatter({chart: this.chart, axis: this.options,
                        ...
                        fontWeight: this.labelFontWeight, fontColor: this.labelFontColor, fontStyle: this.labelFontStyle, textBaseline: "middle"}), this._labels.push({position: m, textBlock: a, effectiveHeight: null, breaksLabelType: void 0}))
                }
            if ("bottom" === this._position || "top" === this._position)
                h = this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length ? this.lineCoordinates.width * Math.log(Math.min(this._labels[this._labels.length - 1].position / this._labels[this._labels.length - 2].position, this._labels[1].position / this._labels[0].position)) /
            ...
            if (this.labelAutoFit || this.options.labelAutoFit)
                if (r(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360, 90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -=
                    ...
                    if (f = 0.9 * h >> 0, q = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
                            ...
                            if (!this._labels[c].breaksLabelType) {
                                ...
                                if (r(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                                    if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? l : Math.min((b - f * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), b),
                                            m = (k - (n + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(-25))) / Math.sin(Math.PI / 180 * Math.abs(-25)), !r(this.options.labelWrap))
                                        ...
                                        if (r(this.options.labelWrap))
                                            if (!r(this.options.labelMaxWidth))
                                                ...
                                                if (b = s.width + d.width >> 0, g = this.labelFontSize, q < f)
                                                    b - 2 * f > p && (p = b - 2 * f, b >= 2 * f && b < 2.2 * f ? (this.sessionVariables.labelMaxWidth =
                                                ...
                                                1].textBlock.measureText().width - 2 * f > p || 0 < v && v < this._labels.length - 1 && q + this._labels[v + 1].textBlock.measureText().width - 2 * f > p && q + this._labels[v - 1].textBlock.measureText().width - 2 * f > p))
                        ...
                        for (b = 0; b < this._labels.length; b++)
                            a = this._labels[b].textBlock, a.maxWidth = this.labelMaxWidth = this.sessionVariables.labelMaxWidth, a.fontSize = this.sessionVariables.labelFontSize,
                        ...
                        for (c = 0; c < this._labels.length; c++)
                            a = this._labels[c].textBlock, a.maxWidth = this.labelMaxWidth = r(this.options.labelMaxWidth) ? r(this.sessionVariables.labelMaxWidth) ? this.sessionVariables.labelMaxWidth = f : this.sessionVariables.labelMaxWidth : this.options.labelMaxWidth, a.fontSize = this.labelFontSize = r(this.options.labelFontSize) ?
                    ...
                    if (f = r(this.options.labelMaxWidth) ? 0.3 * this.chart.width >> 0 : this.options.labelMaxWidth, l = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.3 * this.chart.height >> 0 : 1.5 * this.labelFontSize, !this.chart.panEnabled && 1 <= this._labels.length) {
                        ...
                        for (c = 0; c < this._labels.length; c++)
                            a = this._labels[c].textBlock, a.maxWidth = this.labelMaxWidth = r(this.options.labelMaxWidth) ? r(this.sessionVariables.labelMaxWidth) ? this.sessionVariables.labelMaxWidth =
            ...
            for (c = 0; c < this.stripLines.length; c++) {
                ...
                if ("outside" === f.labelPlacement) {
                    ...
                    if ("left" === this._position || "right" === this._position)
                        r(f.options.labelWrap) && !r(this.sessionVariables.stripLineLabelMaxHeight) ? A = this.sessionVariables.stripLineLabelMaxHeight : this.sessionVariables.stripLineLabelMaxHeight = A = f.labelWrap ? 0.8 * this.chart.width >> 0 : 1.5 * this.labelFontSize;
                ...
                a = new ka(this.ctx, {x: 0, y: 0, backgroundColor: f.labelBackgroundColor, borderColor: f.labelBorderColor, borderThickness: f.labelBorderThickness,
                    cornerRadius: f.labelCornerRadius, maxWidth: f.options.labelMaxWidth ? f.options.labelMaxWidth : l, maxHeight: A, angle: this.labelAngle, text: f.labelFormatter ? f.labelFormatter({chart: this.chart, axis: this, stripLine: f}) : f.label, textAlign: this.labelTextAlign, fontSize: "outside" === f.labelPlacement ? f.options.labelFontSize ? f.labelFontSize : this.labelFontSize : f.labelFontSize, fontFamily: "outside" === f.labelPlacement ? f.options.labelFontFamily ? f.labelFontFamily : this.labelFontFamily : f.labelFontFamily, fontWeight: "outside" ===
                            f.labelPlacement ? f.options.labelFontWeight ? f.labelFontWeight : this.labelFontWeight : f.labelFontWeight, fontColor: f.labelFontColor || f.color, fontStyle: "outside" === f.labelPlacement ? f.options.labelFontStyle ? f.labelFontStyle : this.fontWeight : f.labelFontStyle, textBaseline: "middle"});
            ...
            if ("bottom" === this._position || "top" === this._position) {
                ...
                if ("inside" != this.labelPlacement || "inside" === this.labelPlacement && 0 < this._index)
                    for (c = 0; c < this._labels.length; c++) {
                        ...
                        var e = d.measureText(), f = 0, f = 0 === this.labelAngle ? e.height :
                ...
                for (c = 0; c < this._stripLineLabels.length; c++)
                    "outside" === this._stripLineLabels[c].stripLine.labelPlacement && (this._stripLineLabels[c].stripLine.value >= this.viewportMinimum && this._stripLineLabels[c].stripLine.value <= this.viewportMaximum) && (d = this._stripLineLabels[c].textBlock, e = d.measureText(), f = 0 === this.labelAngle ? e.height : e.width *
        ...
        A.setLayout = function (a, d, c, b, e, f) {
            var l, h, n, k, m = a[0] ? a[0].chart : d[0].chart, p = m.isNavigator ? 0 : 10, q = m._axes;
            if (a && 0 < a.length)
            ...
            for (g = 0; g < q.length; g++)
                if (q[g] && q[g].scaleBreaks && q[g].scaleBreaks._appliedBreaks.length)
                    for (var s = q[g].scaleBreaks._appliedBreaks, w = 0; w < s.length && !(s[w].startValue > q[g].viewportMaximum); w++)
                        s[w].endValue < q[g].viewportMinimum || (r(q[g].scaleBreaks.firstBreakIndex) && (q[g].scaleBreaks.firstBreakIndex =
                                w), s[w].startValue >= q[g].viewPortMinimum && (q[g].scaleBreaks.lastBreakIndex = w));
            for (var v = w = 0, u = 0, y = 0, x = 0, z = 0, A = 0, C, B, E = h = 0, I, J, K, s = I = J = K = !1, g = 0; g < q.length; g++)
                q[g] && q[g].title && (q[g]._titleTextBlock = new ka(q[g].ctx, {text: q[g].title, horizontalAlign: "center", fontSize: q[g].titleFontSize, fontFamily: q[g].titleFontFamily, fontWeight: q[g].titleFontWeight, fontColor: q[g].titleFontColor, fontStyle: q[g].titleFontStyle, borderColor: q[g].titleBorderColor, borderThickness: q[g].titleBorderThickness, backgroundColor: q[g].titleBackgroundColor,
            ...
            if ("normal" === e) {
                for (var y = [], x = [], z = [], A = [], N = [], P = [], O = [], R = []; 4 > w; ) {
                    var F = 0, U = 0, S = 0, V = 0, X = e = 0, L = 0, Z = 0, W = 0, Y = 0, Q = 0, $ = 0;
                    if (c && 0 < c.length)
                        for (z = [], g = Q = 0; g < c.length; g++)
                            z.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)), Q += z[g], L += c[g] && !m.isNavigator ? c[g].margin : 0;
                    else
                        z.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateWidth() : 0));
                    O.push(z);
                    if (b && 0 <
                            b.length)
                        for (A = [], g = $ = 0; g < b.length; g++)
                    ...
                    if (a && 0 < a.length)
                        for (y = [], g = W = 0; g < a.length; g++)
                            a[g] && (a[g].lineCoordinates = {}), a[g].lineCoordinates.width = Math.abs(n - l), a[g].title && (a[g]._titleTextBlock.maxWidth = 0 < a[g].titleMaxWidth && a[g].titleMaxWidth < a[g].lineCoordinates.width ?
                    ...
                    if (d && 0 < d.length)
                        for (x = [], g = Y = 0; g < d.length; g++)
                            d[g] && (d[g].lineCoordinates = {}), d[g].lineCoordinates.width = Math.abs(n - l), d[g].title && (d[g]._titleTextBlock.maxWidth = 0 < d[g].titleMaxWidth && d[g].titleMaxWidth < d[g].lineCoordinates.width ? d[g].titleMaxWidth : d[g].lineCoordinates.width),
                    ...
                    if (a && 0 < a.length)
                        for (g = 0; g < a.length; g++)
                            a[g] && (a[g].lineCoordinates.x1 = l, n = Math.round(f.x2 - $ - Z > m.width - p ? m.width - p : f.x2 - $ - Z), a[g]._labels && 1 < a[g]._labels.length && (h = k = 0, k = a[g]._labels[1], h = "dateTime" === a[g].valueType ? a[g]._labels[a[g]._labels.length - 2] : a[g]._labels[a[g]._labels.length - 1], v = k.textBlock.width * Math.cos(Math.PI /
                    ...
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++)
                            d[g].lineCoordinates.x1 = Math.round(f.x1 + Q + L), d[g].lineCoordinates.x2 = Math.round(f.x2 - $ - Z > m.width - p ? m.width - p : f.x2 - $ - Z), d[g].lineCoordinates.width = Math.abs(n - l), d[g]._labels && 1 < d[g]._labels.length &&
                    ...
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++)
                            L = m.isNavigator ? 0 : 10, c[g] && (l = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), L = c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[c[g]._labels.length - 1].textBlock.height / 2 : p, h = Math.round(f.y1 + Y + X < Math.max(L, p) ? Math.max(L, p) : f.y1 + Y + X), n = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), L = 0 < a.length ? 0 : c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[0].textBlock.height / 2 : p, k = Math.round(f.y2 - W - e - L), c[g].lineCoordinates =
                                    {x1: l - S, y1: h, x2: n - S, y2: k, height: Math.abs(k - h)}, "inside" === c[g].labelPlacement && 0 < g && (c[g].lineCoordinates.x1 = c[g].lineCoordinates.x1 - (z[g] - (c[g]._titleTextBlock ? c[g]._titleTextBlock.height : 0)) + c[g].tickLength, c[g].lineCoordinates.x2 = c[g].lineCoordinates.x1 + c[g].lineThickness / 2), "inside" === c[g].tickPlacement && 0 < g && (c[g].lineCoordinates.x1 -= c[g].tickLength, c[g].lineCoordinates.x2 = c[g].lineCoordinates.x1 + c[g].lineThickness / 2), c[g].bounds = {x1: l - (z[g] + S), y1: h, x2: n - S, y2: k, height: k - h}, c[g].bounds.width =
                    ...
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++)
                            b[g] && (l = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2), n = Math.round(l), L = b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[b[g]._labels.length - 1].textBlock.height / 2 : 0, h = Math.round(f.y1 + Y + X < Math.max(L, p) ? Math.max(L, p) : f.y1 + Y + X), L = 0 < a.length ?
                    ...
                    if (a && 0 < a.length)
                        for (g = 0; g < a.length; g++)
                            a[g] && (a[g].calculateValueToPixelConversionParameters(), a[g].calculateBreaksSizeInValues(), a[g]._labels && 1 < a[g]._labels.length && (C =
                ...
                for (P = []; 4 > w; ) {
                    ...
                    if (a && 0 < a.length)
                        for (E = [], g = V = 0; g < a.length; g++)
                            E.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateWidth() : 0)), V += E[g], e += a[g] && !m.isNavigator ? a[g].margin : 0;
                    else
                        E.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() :
                                0));
                    N.push(E);
                    if (d && 0 < d.length)
                        for (v = [], g = W = 0; g < d.length; g++)
                            v.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateWidth() : 0)), W += v[g], X += d[g] ? d[g].margin : 0;
                    else
                        v.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateWidth() : 0));
                    P.push(v);
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++)
                            c[g].lineCoordinates = {}, l = Math.round(f.x1 + V + e), n = Math.round(f.x2 - W - X > m.width - 10 ? m.width - 10 : f.x2 - W - X), c[g].labelAutoFit && !r(y) && (0 < !a.length && (l = 0 > c[g].labelAngle ? Math.max(l, y) : 0 === c[g].labelAngle ? Math.max(l, y / 2) : l), 0 < !d.length && (n =
                    ...
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++)
                            b[g].lineCoordinates = {}, l = Math.round(f.x1 + V + e), n = Math.round(f.x2 - W - X > b[g].chart.width - 10 ? b[g].chart.width - 10 : f.x2 - W - X), b[g] && b[g].labelAutoFit && !r(z) && (0 < !a.length &&
                    ...
                    if (c && 0 < c.length)
                        for (p = [], g = S = 0; g < c.length; g++)
                            p.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateHeight() : 0)), S += p[g] + c[g].margin, L += c[g].margin;
                    else
                        p.push(Math.ceil(c[0] ?
                        c[0].createLabelsAndCalculateHeight() : 0));
                    B.push(p);
                    if (b && 0 < b.length)
                        for (C = [], g = 0; g < b.length; g++)
                            C.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateHeight() : 0)), Z += b[g].margin;
                    else
                        C.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateHeight() : 0));
                    u.push(C);
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++)
                            0 < c[g]._labels.length && (k = c[g]._labels[0], h = c[g]._labels[c[g]._labels.length - 1], y = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI /
                    ...
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++)
                            b[g] && 0 < b[g]._labels.length && (k = b[g]._labels[0], h = b[g]._labels[b[g]._labels.length - 1], z = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)), A = h.textBlock.width *
                    ...
                    if (m.panEnabled)
                        for (g = 0; g < c.length; g++)
                            p[g] = r(m.sessionVariables.axisY.height) ? m.sessionVariables.axisY.height = p[g] : m.sessionVariables.axisY.height;
                    else
                        for (g = 0; g < c.length; g++)
                            m.sessionVariables.axisY.height = p[g];
                    if (c && 0 < c.length)
                        for (g = c.length - 1; 0 <= g; g--)
                            h = Math.round(f.y2), k = Math.round(f.y2 > c[g].chart.height ? c[g].chart.height : f.y2), c[g].lineCoordinates.y1 =
                                    h - (p[g] + c[g].margin + Y), c[g].lineCoordinates.y2 = h - (p[g] + c[g].margin + Y), "inside" === c[g].labelPlacement && 0 < g && (c[g].lineCoordinates.y1 = c[g].lineCoordinates.y1 + p[g] - (c[g]._titleTextBlock ? c[g]._titleTextBlock.height : 0) - c[g].tickLength - 5, c[g].lineCoordinates.y2 = c[g].lineCoordinates.y1 + c[g].lineThickness / 2), "inside" === c[g].tickPlacement && 0 < g && (c[g].lineCoordinates.y1 += c[g].tickLength, c[g].lineCoordinates.y2 = c[g].lineCoordinates.y1 + c[g].lineThickness / 2), c[g].bounds = {x1: l, y1: h - (p[g] + Y + c[g].margin), x2: n, y2: k -
                                        (Y + c[g].margin), width: n - l, height: p[g]}, c[g].title && (c[g]._titleTextBlock.maxWidth = 0 < c[g].titleMaxWidth && c[g].titleMaxWidth < c[g].lineCoordinates.width ? c[g].titleMaxWidth : c[g].lineCoordinates.width), Y += p[g] + c[g].margin;
                    if (b && 0 < b.length)
                        for (g = b.length - 1; 0 <= g; g--)
                            b[g] && (h = Math.round(f.y1), k = Math.round(f.y1 + (C[g] + b[g].margin + F)), b[g].lineCoordinates.y1 = k, b[g].lineCoordinates.y2 = k, "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.y1 = k - C[g] + (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0) + b[g].tickLength,
                        ...
                        for (g = 0; g < a.length; g++) {
                            ...
                            if (b && 0 < b.length)
                                for (L = 0; L < b.length; L++)
                                    b[L] && b[L].labelAutoFit && (n = b[L].lineCoordinates.x1, l = n - V);
                    ...
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++) {
                            ...
                            if (b && 0 < b.length)
                                for (L = 0; L < b.length; L++)
                                    b[L] && b[L].labelAutoFit && (n = b[L].lineCoordinates.x2, l = n - W);
        ...
        A.prototype.calculateBreaksSizeInValues = function () {
            for (var a = "left" === this._position || "right" === this._position ? this.lineCoordinates.height || this.chart.height : this.lineCoordinates.width || this.chart.width, d = this.scaleBreaks ? this.scaleBreaks._appliedBreaks : [], c = this.conversionParameters.pixelPerUnit || a / (this.logarithmic ? this.conversionParameters.maximum /
                    this.conversionParameters.minimum : this.conversionParameters.maximum - this.conversionParameters.minimum), b = this.scaleBreaks && !r(this.scaleBreaks.options.spacing), e, f = 0; f < d.length; f++)
                e = b || !r(d[f].options.spacing), d[f].spacing = Ta(d[f].spacing, a, 8, e ? 0.1 * a : 8, e ? 0 : 3) << 0, d[f].size = 0 > d[f].spacing ? 0 : Math.abs(d[f].spacing / c), this.logarithmic && (d[f].size = Math.pow(this.logarithmBase, d[f].size))
        };
        A.prototype.calculateBreaksInPixels = function () {
            if (!(this.scaleBreaks && 0 >= this.scaleBreaks._appliedBreaks.length)) {
                ...
                for (var d = 0; d < a.length && !(a[d].startValue > this.conversionParameters.maximum); d++)
                    a[d].endValue < this.conversionParameters.minimum || (r(this.scaleBreaks.firstBreakIndex) && (this.scaleBreaks.firstBreakIndex = d), a[d].startValue >= this.conversionParameters.minimum && (a[d].startPixel = this.convertValueToPixel(a[d].startValue), this.scaleBreaks.lastBreakIndex = d), a[d].endValue <= this.conversionParameters.maximum &&
        ...
        A.prototype.renderLabelsTicksAndTitle = function () {
                ...
                if ("bottom" === this._position || "top" === this._position)
                    if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                        ...
                        for (k = 0; k < this._labels.length; k++)
                            p = this._labels[k], p.position < this.viewportMinimum || (l = p.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + p.textBlock.height *
            ...
            if ("bottom" === this._position) {
                ...
                for (k = 0; k < this._labels.length; k++)
                    p = this._labels[k], p.position < this.viewportMinimum || p.position > this.viewportMaximum || (q = this.getPixelCoordinatesOnAxis(p.position), this.tickThickness && "inside" != this.tickPlacement && (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle =
        ...
        A.prototype.renderInterlacedColors = function () {
            ...
            if (("bottom" === this._position || "top" === this._position) && this.interlacedColor)
                for (a.fillStyle = this.interlacedColor, e = 0; e < this._labels.length; e++)
                    d ? (d = this.getPixelCoordinatesOnAxis(this._labels[e].position), c = e + 1 > this._labels.length - 1 ? this.getPixelCoordinatesOnAxis(this.viewportMaximum) : this.getPixelCoordinatesOnAxis(this._labels[e + 1].position), a.fillRect(Math.min(c.x, d.x), b.y1, Math.abs(c.x -
                    ...
                    if (this.stripLines && 0 < this.stripLines.length && a) {
                            ...
                            if (k = this.stripLines[b], c = this._stripLineLabels[b], !(c.position < this.viewportMinimum || c.position > this.viewportMaximum || isNaN(this.range))) {
                                ...
                                if ("outside" === c.stripLine.labelPlacement)
                                    if (k && (this.ctx.strokeStyle = k.color, this.ctx.lineWidth = "pixel" === k._thicknessType ? k.thickness : this.tickThickness), "bottom" === this._position) {
                                        ...
                                        "top" === this._position ? (m = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, this.ctx.beginPath(), this.ctx.moveTo(m, a.y << 0), this.ctx.lineTo(m, a.y - this.tickLength <<
                        ...
                        if (!l) {
                            ...
                            for (b = 0; b < n.length; b++)
                                c = n[b], c.stripLine.showOnTop ? l || (l = !0, this.chart.addEventListener("dataAnimationIterationEnd",
                                        function () {
                                            for (e = 0; e < n.length; e++)
                                                c = n[e], "inside" === c.stripLine.labelPlacement && c.stripLine.showOnTop && (d.ctx.save(), d.ctx.beginPath(), d.ctx.rect(d.chart.plotArea.x1, d.chart.plotArea.y1, d.chart.plotArea.width, d.chart.plotArea.height), d.ctx.clip(), c.textBlock.render(!0), d.ctx.restore())
        ...
        A.prototype.renderCrosshair = function (a, d) {
            isFinite(this.minimum) && isFinite(this.maximum) && (this.crosshair.render(a, d), this.crosshair.dispatchEvent("updated", {chart: this.chart, crosshair: this.crosshair.options, axis: this, value: this.crosshair.value}, this))
        };
                ...
                if (this.lineThickness) {
                    ...
                    if (this.scaleBreaks && !r(this.scaleBreaks.firstBreakIndex))
                        if (r(this.scaleBreaks.lastBreakIndex))
                            ...
                            for (var h =
                                    this.scaleBreaks.firstBreakIndex; h <= this.scaleBreaks.lastBreakIndex; h++)
                ...
                if (this.scaleBreaks && !r(this.scaleBreaks.firstBreakIndex))
                    if (r(this.scaleBreaks.lastBreakIndex))
                        ...
                        for (h = this.scaleBreaks.firstBreakIndex; h <= this.scaleBreaks.lastBreakIndex; h++)
                            d.moveTo(l, e), d.lineTo(l, this.scaleBreaks._appliedBreaks[h].startPixel + b),
                            ...
                            if (d)
                                if (e[c].startValue < this.conversionParameters.minimum) {
                                    if (1 < e[c].size && this.conversionParameters.minimum * Math.pow(e[c].endValue / e[c].startValue, Math.log(b) / Math.log(e[c].size)) < e[c].endValue) {
                                        ...
                                        a *= e[c].endValue / this.conversionParameters.minimum /
                        ...
                        if (!(e[c].startValue > this.conversionParameters.minimum))
                            if (d)
                                if (e[c].endValue > this.conversionParameters.minimum) {
                                    ...
                                    e[c].startValue, Math.log(b) / Math.log(e[c].size)) > e[c].startValue) {
                                        a = Math.pow(e[c].endValue / e[c].startValue, Math.log(b) / Math.log(e[c].size));
                                        break
                                    } else
                        ...
                        if (!(e[c].startValue > this.conversionParameters.minimum))
                            if (d)
                                if (e[c].endValue > this.conversionParameters.minimum)
                                    ...
                                    e[c].startValue) / e[c].size > e[c].startValue) {
                                        a = 0 >= e[c].size ? 0 : b * (e[c].endValue - e[c].startValue) / e[c].size;
                                        break
                                    } else
                                        a += e[c].startValue - this.conversionParameters.minimum + e[c].size * (this.conversionParameters.minimum - e[c].startValue) / (e[c].endValue - e[c].startValue), b += e[c].size * (this.conversionParameters.minimum - e[c].startValue) / (e[c].endValue - e[c].startValue), d = !1;
                                else if (b < e[c].endValue - this.conversionParameters.minimum) {
        ...
        A.prototype.getApparentDifference = function (a,
            ...
            if (this.logarithmic) {
                ...
                for (c = r(c)?Math.abs(d - a):c, f = 0; f < e.length && !(d < e[f].startValue); f++)
                    a > e[f].endValue || (a <= e[f].startValue && d >= e[f].endValue ? c = c - e[f].endValue + e[f].startValue + e[f].size : a > e[f].startValue && d >= e[f].endValue ? c = c - e[f].endValue + a + e[f].size * (e[f].endValue - a) / (e[f].endValue - e[f].startValue) : a <= e[f].startValue && d < e[f].endValue ? c = c - d + e[f].startValue + e[f].size * (d - e[f].startValue) /
        ...
        A.prototype.calculateValueToPixelConversionParameters = function (a) {
            ...
            if (this.logarithmic)
                ...
                for (e = 0; e < a.length && !(this.viewportMaximum < a[e].startValue); e++)
                    this.viewportMinimum > a[e].endValue || (this.viewportMinimum >= a[e].startValue && this.viewportMaximum <= a[e].endValue ? c = 0 : this.viewportMinimum <= a[e].startValue && this.viewportMaximum >= a[e].endValue ? (b = b - a[e].endValue + a[e].startValue, c = 0 < a[e].spacing.toString().indexOf("%") ? c * (1 - parseFloat(a[e].spacing) / 100) : c - Math.min(a[e].spacing, 0.1 * c)) : this.viewportMinimum > a[e].startValue && this.viewportMaximum >= a[e].endValue ? (b = b - a[e].endValue + this.viewportMinimum,
        ...
        A.prototype.calculateAxisParameters = function () {
            if (this.logarithmic)
                ...
                if ("axisX" === this.type) {
                    ...
                    "axisY" === this.type && (e = null !== this.viewportMinimum ? this.viewportMinimum : this.dataInfo.viewPortMin, f = null !== this.viewportMaximum ? this.viewportMaximum :
                ...
                if ("axisX" === this.type && c) {
                    ...
                    if (null === this.viewportMaximum ||
                        ...
                        this.viewportMaximum = "axisX" === this.type ? f + h / 2 : Math.ceil(f / this.interval) * this.interval;
                ...
                if (null === this.minimum || null === this.maximum)
                    if ("axisX" === this.type ? (e =
                        ...
                        if (null === this.minimum || isNaN(this.minimum))
                            this.minimum = e - h / 2, this.minimum = Math.min(this.minimum, null === this.sessionVariables.viewportMinimum || isNaN(this.sessionVariables.viewportMinimum) ? Infinity : this.sessionVariables.viewportMinimum);
                        ...
                        this.intervalType = this.valueType = "number", null === this.minimum && (this.minimum = "axisX" === this.type ? e - h / 2 : Math.floor(e / this.interval) * this.interval, this.minimum = Math.min(this.minimum, null === this.sessionVariables.viewportMinimum || isNaN(this.sessionVariables.viewportMinimum) ? Infinity : this.sessionVariables.viewportMinimum)),
        ...
        A.prototype.calculateLogarithmicAxisParameters =
                function () {
                    ...
                    "bottom" === this._position || "top" === this._position ? (this.maxWidth = a.width, this.maxHeight = a.height) : (this.maxWidth = a.height, this.maxHeight = a.width);
                    var a = "axisX" === this.type ? 500 > this.maxWidth ? 7 : Math.max(7, Math.floor(this.maxWidth / 100)) : Math.max(Math.floor(this.maxWidth / 50), 3), b, e, f, h;
                    h = 1;
                    if (null === this.viewportMinimum || isNaN(this.viewportMinimum))
                        this.viewportMinimum = this.minimum;
                    if (null === this.viewportMaximum ||
                    ...
                    if (null === this.minimum || null === this.maximum)
                        "axisX" === this.type ? (b = null !== this.minimum ? this.minimum : this.dataInfo.min, e = null !== this.maximum ? this.maximum : this.dataInfo.max, 1 === e / b && (h = Math.pow(this.logarithmBase, "undefined" === typeof this.options.interval ? 0.4 : this.options.interval), e *= h, b /= h), f = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : e / b > this.logarithmBase ?
                    ...
                    if (!this.options.interval && this.range < Math.pow(this.logarithmBase, 8 > this.viewportMaximum || 3 > a ? 2 : 3)) {
                        ...
                        this.options.interval || (c = Math.ceil(this.interval), this.range > this.interval &&
        ...
        A.prototype.getLabelStartPoint = function () {
            var a = I[this.intervalType + "Duration"] * this.interval, a = new Date(Math.floor(this.viewportMinimum / a) * a);
            ...
            if (0 !==
                ...
                if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
                    if (b = 1 === p % 2 ? (b.x << 0) + 0.5 : b.x << 0, h = 1 === p % 2 ? (e.x << 0) + 0.5 : e.x << 0, "top" === this.scaleBreaks.parent._position ? (e = this.chart.plotArea.y1, n = this.chart.plotArea.y2 +
                            p / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2, n = this.chart.plotArea.y1 - p / 2 + 0.5 << 0, a *= -1), this.bounds = {x1: b - p / 2, y1: e, x2: h + p / 2, y2: n}, this.ctx.moveTo(b, e), "straight" === this.type || "top" === this.scaleBreaks.parent._position && 0 >= a || "bottom" === this.scaleBreaks.parent._position && 0 <= a)
                        ...
                        m = (n - k) / a / 3;
                        for (var q = 0; q < m; q++)
                            this.ctx.bezierCurveTo(r + f * a, k + a, r + f * a, k + 2 * a, r, k + 3 * a), k += 3 * a, f *= -1;
                        ...
                        if ("zigzag" === this.type) {
                            ...
                            m = (n - k) / a / 2;
                            for (q = 0; q < m; q++)
                                this.ctx.lineTo(r, k), r += 2 * f * a, k += 2 * a, f *= -1;
                            this.ctx.lineTo(r, k);
                            r += h - b;
                            for (q = 0; q < m + 1; q++)
                                this.ctx.lineTo(r, k), r += 2 * f * a, k -= 2 * a, f *= -1;
                    ...
                    if (e = 1 === p % 2 ? (e.y << 0) + 0.5 : e.y <<
                            0, n = 1 === p % 2 ? (b.y << 0) + 0.5 : b.y << 0, "left" === this.scaleBreaks.parent._position ? (b = this.chart.plotArea.x1, h = this.chart.plotArea.x2 + p / 2 + 0.5 << 0) : (b = this.chart.plotArea.x2, h = this.chart.plotArea.x1 - p / 2 + 0.5 << 0, a *= -1), this.bounds = {x1: b, y1: e - p / 2, x2: h, y2: n + p / 2}, this.ctx.moveTo(b, e), "straight" === this.type || "left" === this.scaleBreaks.parent._position && 0 >= a || "right" === this.scaleBreaks.parent._position && 0 <= a)
                        ...
                        m =
                                (h - r) / a / 3;
                        for (q = 0; q < m; q++)
                            this.ctx.bezierCurveTo(r + a, k + f * a, r + 2 * a, k + f * a, r + 3 * a, k), r += 3 * a, f *= -1;
        ...
        P.prototype.render = function () {
            ...
            if (0 < d) {
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position)
                    ...
                    h = n = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0, e = this.chart.plotArea.x1, f = this.chart.plotArea.x2, this.bounds = {x1: e, y1: h - d / 2, x2: f,
                        y2: n + d / 2};
                this.ctx.moveTo(e, h);
                this.ctx.lineTo(f, n);
                this.ctx.stroke();
        ...
        Y.prototype.showAt = function (a) {
            ...
            if ("xySwapped" === d.plotInfo.axisPlacement)
                if ("bottom" === this.parent._position)
                    for (var b = 0; b < d.axisY.length; b++)
                        this.parent === d.axisY[b] && (d.axisY[b]._crosshairValue = a >= d.axisY[b].viewportMinimum &&
                ...
                for (b = 0; b < d.axisY2.length; b++)
                    this.parent === d.axisY2[b] && (d.axisY2[b]._crosshairValue = a >= d.axisY2[b].viewportMinimum && a <= d.axisY2[b].viewportMaximum ? a : null);
            for (b = 0; b < d.axisX.length; b++)
                a = d.axisX[b]._crosshairValue, d.axisX[b].crosshair && (d.axisX[b].crosshair.enabled && !r(a) &&
            ...
            for (b = 0; b < d.axisY2.length; b++)
                a = d.axisY2[b]._crosshairValue, d.axisY2[b].crosshair && (d.axisY2[b].crosshair.enabled && !r(a) && a >= d.axisY2[b].viewportMinimum && a <= d.axisY2[b].viewportMaximum) && (d.axisY2[b].showCrosshair(a), d.axisY2[b].crosshair._updatedValue = a, this === d.axisY2[b].crosshair &&
                        (c = !0));
        ...
        Y.prototype.render = function (a, d, c) {
            var b, e, f, h, n = null, w = null, k = null, m = "";
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    for (var B = 0; B < this.parent.dataSeries.length; B++)
                        (v = this.parent.dataSeries[B].getDataPointAtX(s, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[B], null !== v.dataPoint.y && v.dataSeries.visible &&
                                m.push(v));
                    v = null;
                    if (0 === m.length)
                        return;
                    ...
                    if ("rangeBar" === m[0].dataSeries.type || "error" === m[0].dataSeries.type)
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(m[B].dataPoint.y[0])), u = 0, s = 0; s < m.length; s++)
                            if (m[s].dataPoint.y && m[s].dataPoint.y.length)
                                for (var y = 0; y < m[s].dataPoint.y.length; y++)
                                    u = Math.abs(a - this.parent.convertValueToPixel(m[s].dataPoint.y[y])), u < v && (v = u, B = s);
                            else
                                u =
                        ...
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), x = u = 0, s = B = 0; s < m.length; s++)
                            if (m[s].dataPoint.y && m[s].dataPoint.y.length)
                                ...
                                x += m[s].dataPoint.y, u = Math.abs(a - this.parent.convertValueToPixel(x)), u < v && (v = u, B = s);
                        ...
                        for (var v =
                            ...
                            if (m[s].dataPoint.y && m[s].dataPoint.y.length)
                                ...
                                x += m[s].dataPoint.y, z = m[s].dataPoint.x.getTime ? m[s].dataPoint.x.getTime() : m[s].dataPoint.x, z = 100 * (x / m[s].dataSeries.plotUnit.dataPointYSums[z]), u = Math.abs(a - this.parent.convertValueToPixel(z)), u < v && (v = u, B = s);
                    else
                        for (v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)),
                            ...
                            if (m[s].dataPoint.y && m[s].dataPoint.y.length)
                                ...
                                u = Math.abs(a - this.parent.convertValueToPixel(m[s].dataPoint.y)), u < v && (v = u, B = s);
                    y = m[B];
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        b = 0;
                        if ("rangeBar" === this.parent.dataSeries[B].type || "error" === this.parent.dataSeries[B].type) {
                            ...
                            for (s = u = 0; s < y.dataPoint.y.length; s++)
                                u = Math.abs(a - this.parent.convertValueToPixel(y.dataPoint.y[s])), u < v && (v = u, b = s);
                            ...
                            n = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(y.dataPoint.y) << 0) + 0.5 : this.parent.convertValueToPixel(y.dataPoint.y) << 0, this.value = y.dataPoint.y, k.text = this.labelFormatter ? this.labelFormatter({chart: this.chart, axis: this.parent.options,
                                crosshair: this.options, value: y.dataPoint.y}) : r(this.options.label) ? fa(r(c) ? y.dataPoint.y : c, this.valueFormatString, this.chart._cultureInfo) : this.label;
                        b = e = n;
                        ...
                        if (z) {
                            if ("axisX" === this.parent.type)
                                for (s = this.parent.convertPixelToValue({y:d}), v = null, B = 0; B < this.parent.dataSeries.length; B++)
                                    (v = this.parent.dataSeries[B].getDataPointAtX(s, !0)) && 0 <= v.index && (k.text = this.labelFormatter ? this.labelFormatter({chart: this.chart, axis: this.parent.options, crosshair: this.options, value: y.dataPoint.x}) : r(this.options.label) ? v.dataPoint.label : this.label)
                        } else
                            k.text = "dateTime" !== this.parent.valueType || this.parent.logarithmic ?
                    ...
                    if (z) {
                        if ("axisX" === this.parent.type)
                            for (s = this.parent.convertPixelToValue({x:a}), v = null, B = 0; B < this.parent.dataSeries.length; B++)
                                (v = this.parent.dataSeries[B].getDataPointAtX(s, !0)) && 0 <= v.index && (k.text = this.labelFormatter ? this.labelFormatter({chart: this.chart, axis: this.parent.options, crosshair: this.options, value: y.dataPoint.x}) : r(this.options.label) ? v.dataPoint.label : this.label)
                    } else
                        k.text = "dateTime" !== this.parent.valueType ||
                    ...
                    for (B = 0; B < this.parent.dataSeries.length; B++)
                        (v = this.parent.dataSeries[B].getDataPointAtX(s, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[B], null !== v.dataPoint.y && v.dataSeries.visible && m.push(v));
                    if (0 === m.length)
                        return;
                    m.sort(function (a, b) {
                        return a.distance - b.distance
                    ...
                    if ("rangeColumn" === m[0].dataSeries.type || "rangeArea" === m[0].dataSeries.type || "error" === m[0].dataSeries.type || "rangeSplineArea" === m[0].dataSeries.type || "candlestick" === m[0].dataSeries.type || "ohlc" === m[0].dataSeries.type ||
                        ...
                        for (v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y[0])), s = u = 0; s < m.length; s++)
                            if (m[s].dataPoint.y && m[s].dataPoint.y.length)
                                for (y = 0; y < m[s].dataPoint.y.length; y++)
                                    u = Math.abs(d - this.parent.convertValueToPixel(m[s].dataPoint.y[y])), u < v && (v = u, B = s);
                            else
                                u = Math.abs(d - this.parent.convertValueToPixel(m[s].dataPoint.y)), u < v && (v = u, B = s);
                        ...
                        for (v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y)),
                            ...
                            if (m[s].dataPoint.y && m[s].dataPoint.y.length)
                                ...
                                x += m[s].dataPoint.y, u = Math.abs(d - this.parent.convertValueToPixel(x)), u < v && (v = u, B = s);
                        ...
                        for (v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y)), s = z = x = u = 0; s < m.length; s++)
                            if (m[s].dataPoint.y && m[s].dataPoint.y.length)
                                for (y =
                                        0; y < m[s].dataPoint.y.length; y++)
                                    u = Math.abs(d - this.parent.convertValueToPixel(m[s].dataPoint.y[y])), u < v && (v = u, B = s);
                            else
                                x += m[s].dataPoint.y, z = m[s].dataPoint.x.getTime ? m[s].dataPoint.x.getTime() : m[s].dataPoint.x, z = 100 * (x / m[s].dataSeries.plotUnit.dataPointYSums[z]), u = Math.abs(d - this.parent.convertValueToPixel(z)), u < v && (v = u, B = s);
                    else
                    ...
                    if ("rangeColumn" === this.parent.dataSeries[B].type || "rangeArea" === this.parent.dataSeries[B].type || "error" === this.parent.dataSeries[B].type || "rangeSplineArea" === this.parent.dataSeries[B].type || "candlestick" === this.parent.dataSeries[B].type || "ohlc" === this.parent.dataSeries[B].type || "boxAndWhisker" === this.parent.dataSeries[B].type) {
                        ...
                        for (s = u = 0; s < y.dataPoint.y.length; s++)
                            u = Math.abs(d - this.parent.convertValueToPixel(y.dataPoint.y[s])), u < v && (v = u, b = s);
                        ...
                        k.text = this.labelFormatter ? this.labelFormatter({chart: this.chart,
                            axis: this.parent.options, crosshair: this.options, value: y.dataPoint.y}) : r(this.options.label) ? fa(r(c) ? y.dataPoint.y : c, this.valueFormatString, this.chart._cultureInfo) : this.label;
                        this.value = x
                    } else if ("stackedColumn100" === this.parent.dataSeries[B].type || "stackedArea100" === this.parent.dataSeries[B].type) {
                        v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y));
                        x = u = 0;
                        for (s = B; 0 <= s; s--)
                            x += m[s].dataPoint.y, z = m[s].dataPoint.x.getTime ? m[s].dataPoint.x.getTime() : m[s].dataPoint.x, z = 100 * (x / m[s].dataSeries.plotUnit.dataPointYSums[z]),
                        ...
                        "waterfall" === this.parent.dataSeries[B].type ? (w = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(y.dataSeries.dataPointEOs[y.index].cumulativeSum) <<
                ...
                m = null;
                if ("bottom" === this.parent._position || "top" === this.parent._position)
                    "top" === this.parent._position && k.y - k.fontSize / 2 < this.chart.bounds.y1 && (k.y = this.chart.bounds.y1 + k.fontSize /
                ...
                if ("left" === this.parent._position ||
                    ...
                    "left" === this.parent._position && k.x < this.chart.bounds.x1 && (k.x = this.chart.bounds.x1), "right" === this.parent._position && k.x + k.measureText().width > this.chart.bounds.x2 && (k.x = this.chart.bounds.x2 - k.measureText().width), h >= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMinimum : this.parent.viewportMaximum) && f <= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMaximum : this.parent.viewportMinimum) && (0 < p && (q.moveTo(b, f), q.lineTo(e,
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement)
                    if ("left" ===
                        ...
                        if (z) {
                            if ("axisX" === this.parent.type)
                                for (s = this.parent.convertPixelToValue({y:d}), v = null, B = 0; B < this.parent.dataSeries.length; B++)
                                    (v = this.parent.dataSeries[B].getDataPointAtX(s, !0)) && 0 <= v.index && (k.text = this.labelFormatter ? this.labelFormatter({chart: this.chart, axis: this.parent.options, crosshair: this.options,
                                        value: r(c) ? this.parent.convertPixelToValue(a) : c}) : r(this.options.label) ? v.dataPoint.label : this.label)
                        } else
                            k.text = "dateTime" !== this.parent.valueType || this.parent.logarithmic ? this.labelFormatter ? this.labelFormatter({chart: this.chart, axis: this.parent.options, crosshair: this.options, value: r(c) ? this.parent.convertPixelToValue(d) : c}) : r(this.options.label) ? fa(r(c) ? this.parent.convertPixelToValue(d) : c, this.valueFormatString, this.chart._cultureInfo) : this.label : this.labelFormatter ? this.labelFormatter({chart: this.chart,
                                axis: this.parent.options, crosshair: this.options, value: r(c) ? this.parent.convertPixelToValue(d) : c}) : r(this.options.label) ? Aa(r(c) ? this.parent.convertPixelToValue(d) : c, this.valueFormatString, this.chart._cultureInfo) : this.label;
                        ...
                        if ("bottom" === this.parent._position || "top" === this.parent._position)
                            k.text = this.labelFormatter ? this.labelFormatter({chart: this.chart, axis: this.parent.options, crosshair: this.options, value: r(c) ? this.parent.convertPixelToValue(a) : c}) : r(this.options.label) ? fa(r(c) ? this.parent.convertPixelToValue(a) : c, this.valueFormatString, this.chart._cultureInfo) : this.label, k.x = b - k.measureText().width /
                    ...
                    if (z) {
                        if ("axisX" === this.parent.type)
                            for (s = this.parent.convertPixelToValue({x:a}), v = null, B = 0; B < this.parent.dataSeries.length; B++)
                                (v = this.parent.dataSeries[B].getDataPointAtX(s, !0)) && 0 <= v.index && (k.text = this.labelFormatter ? this.labelFormatter({chart: this.chart, axis: this.parent.options, crosshair: this.options, value: r(c) ? this.parent.convertPixelToValue(a) : c}) : r(this.options.label) ? r(c) ? v.dataPoint.label : c : this.label)
                    } else
                        k.text = "dateTime" !== this.parent.valueType || this.parent.logarithmic ?
                ...
                if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                    ...
                    if (this.chart.axisX)
                        for (var v = 0; v < this.chart.axisX.length; v++) {
                            for (var h = "xySwapped" === this.chart.plotInfo.axisPlacement ? this.chart.axisX[v].convertPixelToValue({y: d}) : this.chart.axisX[v].convertPixelToValue({x: a}), k = null, b = 0; b < this.chart.axisX[v].dataSeries.length; b++)
                                (k = this.chart.axisX[v].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[v].dataSeries[b], null !== k.dataPoint.y && k.dataSeries.visible && n.push(k));
                            k = null
                        }
                    if (this.chart.axisX2)
                        for (v = 0; v < this.chart.axisX2.length; v++) {
                            ...
                            for (b = 0; b < this.chart.axisX2[v].dataSeries.length; b++)
                                (k = this.chart.axisX2[v].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX2[v].dataSeries[b], null !== k.dataPoint.y && k.dataSeries.visible && n.push(k));
                            k = null
                        }
                    if (0 === n.length)
                        return;
                    ...
                    if (0 <= this.currentSeriesIndex) {
                        ...
                        if (0 <= this.currentDataPointIndex)
                            b = e.dataPoints[this.currentDataPointIndex], k.dataSeries = e, k.dataPoint = b, k.index = this.currentDataPointIndex, k.distance = Math.abs(b.x - h), "waterfall" === e.type && (k.cumulativeSumYStartValue = e.dataPointEOs[this.currentDataPointIndex].cumulativeSumYStartValue, k.cumulativeSum = e.dataPointEOs[this.currentDataPointIndex].cumulativeSum);
                        else {
                            if (!this.enabled || "line" !==
                                    e.type && "stepLine" !== e.type && "spline" !== e.type && "area" !== e.type && "stepArea" !== e.type && "splineArea" !== e.type && "stackedArea" !== e.type && "stackedArea100" !== e.type && "rangeArea" !== e.type && "rangeSplineArea" !== e.type && "candlestick" !== e.type && "ohlc" !== e.type && "boxAndWhisker" !== e.type)
                                return;
                        ...
                        if (!r(k) && !r(k.dataPoint) && !r(k.dataPoint.y))
                            if (k.dataSeries.axisY)
                                if (0 < k.dataPoint.y.length) {
                                    ...
                                    "column" === e.type || "bar" === e.type ? 0 > k.dataPoint.y ? 0 > k.dataSeries.axisY.viewportMinimum && k.dataSeries.axisY.viewportMaximum >= k.dataPoint.y && f.push(k) : k.dataSeries.axisY.viewportMinimum <= k.dataPoint.y && 0 <= k.dataSeries.axisY.viewportMaximum && f.push(k) : "bubble" === e.type ? (c = this.chart._eventManager.objectMap[e.dataPointIds[k.index]].size /
                    ...
                    if (this.highlightObjects(f), this.enabled) {
                        ...
                        if (null !== c) {
                            ...
                            if (this.isToolTipDefinedInData && r(this.options.content) && r(this.options.contentFormatter))
                                for (h = this.contentDiv.getElementsByTagName("span"), b = 0; b < h.length; b++)
                            ...
                            this.hide(!1), this.enabled && this.dispatchEvent("hidden", {chart: this.chart, toolTip: this}, this);
                        d = [];
                        for (b = 0; b < f.length; b++)
                            d.push({xValue: f[b].dataPoint.x, dataPoint: f[b].dataPoint, dataSeries: f[b].dataSeries, dataPointIndex: f[b].index,
        ...
        Z.prototype.highlightObjects = function (a) {
            ...
            if (r(this.chart.clearedOverlayedCanvas) || "toolTip" === this.chart.clearedOverlayedCanvas)
                this.chart.resetOverlayedCanvas(), d.clearRect(0, 0, this.chart.width, this.chart.height),
            ...
            for (c = 0; c < a.length; c++) {
                ...
                if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint" === e.objectType) {
                    var b = this.chart.data[e.dataSeriesIndex], f = b.dataPoints[e.dataPointIndex], h = e.dataPointIndex;
        ...
        Z.prototype.showAtX = function (a, d) {
            ...
            if (this.shared)
                ...
                c = this.chart.data[d], (b = c.getDataPointAtX(a, !1)) && (b.dataPoint && !r(b.dataPoint.y) && c.visible) && (b.dataSeries = c, f.push(b));
            if (0 < f.length) {
                ...
                if (null !== h) {
                    ...
                    if (this.isToolTipDefinedInData && r(this.options.content) &&
                        ...
                        for (b = this.contentDiv.getElementsByTagName("span"), h = 0; h < b.length; h++)
            ...
            if ("mousemove" ===
                ...
                if ((b = this.chart.getObjectAtXY(c.x, c.y, !1)) && "undefined" !== typeof this.objectMap[b])
                    if (b = this.objectMap[b], "dataPoint" === b.objectType) {
                        ...
                        b.eventContext = {context: f, userContext: f, mouseover: "mouseover", mousemove: "mousemove", mouseout: "mouseout",
                            click: "click"};
                        d.push(b);
                        ...
                        "legendItem" === b.objectType && (e = this.chart.data[b.dataSeriesIndex], f = null !== b.dataPointIndex ? e.dataPoints[b.dataPointIndex] : null, b.eventParameter = {x: c.x, y: c.y, dataSeries: e.options,
                            dataPoint: f, dataPointIndex: b.dataPointIndex, dataSeriesIndex: b.dataSeriesIndex, chart: this.chart}, b.eventContext = {context: this.chart.legend, userContext: this.chart.legend.options, mouseover: "itemmouseover", mousemove: "itemmousemove", mouseout: "itemmouseout", click: "itemclick"}, d.push(b));
                e = [];
        ...
        ja.prototype.animate = function (a,
            ...
            for (a = []; 0 < this.animations.length; )
                if (d = this.animations.shift(), c = (new Date).getTime(), b = 0, d.startTime <= c && (b = e(Math.min(c - d.startTime, d.duration), 0, 1, d.duration), b = Math.min(b, 1), isNaN(b) || !isFinite(b)) && (b = 1), 1 > b && a.push(d), d.animationCallback(b), 1 <= b && d.onComplete)
                    d.onComplete();
            this.animations = a;
